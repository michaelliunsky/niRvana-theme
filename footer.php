...
<div class="footer-scripts">
	<?php get_sidebar(); ?>
	<script type="text/html" jQVue-template="fullscreen_search">
		<div class="container">
					...
					<div class="modal-body">
						...
						<div>
							<ul class="nav nav-tabs" role="tablist">
								<?php
								$dashang_Imgs = _opt( 'dashang_Imgs', array() );
...
';
			...
			<div class="chat_pop">
				...
				if ( $faq_dafault_list ) {
					if ( count( $faq_dafault_list ) > 0 ) {
						...
						<ol>
							<?php
							foreach ( $faq_dafault_list as $item ) {
	...
	<?php wp_footer(); ?>
	<?php
	if ( get_option( 'custom_javascript' ) ) {
