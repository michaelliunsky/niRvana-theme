...
<div class="footer-scripts"><?php get_sidebar(); ?><script type="text/html" jQVue-template="fullscreen_search">
        <div class="container">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title"><?php _eopt('dashangTitle', '打赏'); ?></h4>
                    </div>
                    <div class="modal-body">
                        <p><?php _eopt('dashangText', ''); ?></p>
                        <div>
...
';
    ...
    <script type="text/html" jQVue-template="floatTools">
        <div class="floatTools"><?php if (_opt('enable_backToTop')) {?><div class="tool-button backToTop unavailable" @click="this.backToTop()"><i class="fas fa-rocket"></i></div><?php }if (_opt('enable_assistance')) {?><div class="tool-button assistance" @click="this.showAssistance()"><i class="fas fa-headset"></i></div><?php }?><div id="colorSwitch" onclick="switchNightMode()" data-description="色彩模式" data-placement="left" class="tool-button pandastudio_format_description"><i class="colorSwitch fas fa-moon"></i></div>
        </div>
    </script>
...
<script type='text/javascript' src='<?php echo get_stylesheet_directory_uri(); ?>/extend/js/custom.js' id='custom-js'></script>
