    ...
    methods: {
      ...
      toggle_mobile_menu: function () {
        $("#wrapper").hasClass("sidebar-visible")
          ? this.$message(d("本主题由“michaelliunsky”开发"))
      ...
      global_search: function () {
        ...
        if ("" == this.global_search_query)
          return this.$alert(d("请输入搜索关键词！")), !1;
        var e = [];
        if (
        ...
        if ("submit" == $(e.target).attr("type"));
          ...
          if (
            (this.is_user_loggedin ||
              (("" == this.comment_author.replace(/ /g, "")) &
                this.comment_require_name_email && t.push(d("昵称未填写")),
              ("" == this.comment_email.replace(/ /g, "")) &
                this.comment_require_name_email && t.push(d("邮箱未填写")),
              ("" != this.comment_email.replace(/ /g, "")) &
          ...
          if (0 == t.length && this.$isHuman.check()) {
            ...
            if (
              ...
              return this.enable_pageLoader(d("严重错误：评论地址无效")), !1;
      ...
      init_comments: function () {
        ...
        if (
          ...
          $(".comment-meta.nick-name.loggedin").popover({
            ...
            placement: "top",
            trigger: "focus",
            title: d('<i class="fas fa-sign-out-alt"></i> 退出登录？'),
          }),
          $(".comment-meta.nick-name.guests").click(function (e) {
            t.optionsLoaded
              ...
              : t.message(d("<b>请稍后</b><br>网页还未加载完成"));
          }),
              ...
              .done(function (e) {
                $(".post-like.like.favorite > .count.number").html(e),
                  ...
                  $(".post-like.like.favorite i")
                    ...
                    .addClass("fas"),
                  window.setTimeout(function () {
                    t.$message(d("已赞，感谢您的支持！"));
                  }, 1e3),
                  (window._ajaxForceCache = {});
              })
              .fail(function () {
                t.$alert(d("<b>网络错误</b><br>请刷新后再试！"));
              }));
      },
