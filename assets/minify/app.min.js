function PdMessage() {
  ...
  function t(e, t) {
    if (1 == e) {
      if (
        ((PdMessage.prototype.Modal_background_instance.el.style.zIndex =
          PdMessage.prototype.index - 1),
        0 == PdMessage.prototype.model_zIndexs.length)
      )
        document.body.appendChild(
          PdMessage.prototype.Modal_background_instance.el
        );
      window.setTimeout(function () {
        PdMessage.prototype.Modal_background_instance.el.className =
          "pdModal_background";
      }, 16),
        PdMessage.prototype.model_zIndexs.push(PdMessage.prototype.index);
    } else
      PdMessage.prototype.model_zIndexs.splice(
        PdMessage.prototype.model_zIndexs.indexOf(t),
        1
      ),
        0 == PdMessage.prototype.model_zIndexs.length
          ? (PdMessage.prototype.model_zIndexs.pop(),
            (PdMessage.prototype.Modal_background_instance.el.className =
              "pdModal_background is_disappearing is_changing"),
            window.setTimeout(function () {
              PdMessage.prototype.Modal_background_instance.el.parentNode.removeChild(
                PdMessage.prototype.Modal_background_instance.el
              );
            }, 350))
          : (PdMessage.prototype.Modal_background_instance.el.style.zIndex =
              PdMessage.prototype.model_zIndexs[
                PdMessage.prototype.model_zIndexs.length - 1
              ] - 1);
  }
  function i(e) {
    (this.el = document.createElement("div")),
      (this.el.className = "pdmsg_wrapper is_showing is_changing"),
      (this.el.style.zIndex = PdMessage.prototype.index),
      (PdMessage.prototype.index += 2),
      (this.modal = document.createElement("div")),
      (this.modal.className = "pdmsg_modal " + e._type),
      (this.title = document.createElement("div")),
      (this.title.className = "pdmsg_title"),
      this.title.appendChild(document.createTextNode(e.title || "")),
      (this.content = document.createElement("div")),
      (this.content.className =
        "pdmsg_content" + (e.messageType ? " " + e.messageType : "")),
      (this.contentSpan = document.createElement("span")),
      this.contentSpan.appendChild(document.createTextNode(e.message || "")),
      this.content.appendChild(this.contentSpan),
      "prompt" == e._type &&
        ((this.prompt_input_wrapper = document.createElement("div")),
        (this.prompt_input_wrapper.className = "prompt_input_wrapper"),
        (this.prompt_input = document.createElement(
          e.promptType ? e.promptType : "input"
        )),
        (this.prompt_input.className = "input"),
        (this.prompt_input.value = e.value ? e.value : ""),
        this.prompt_input.setAttribute(
          "placeholder",
          e.placeholder ? e.placeholder : ""
        ),
        this.prompt_input_wrapper.appendChild(this.prompt_input)),
      (this.buttons = document.createElement("div")),
      (this.buttons.className = "pdmsg_buttons");
    var t = [];
    ("confirm" != e._type && "prompt" != e._type) ||
      ((this.cancel = document.createElement("button")),
      this.cancel.appendChild(document.createTextNode(e.cancel || "取消")),
      ...
      this.confirm.appendChild(document.createTextNode(e.confirm || "确定")),
      (this.confirm.className = e.confirmType);
    ...
    this.modal.appendChild(this.title),
      ...
      "prompt" == e._type && this.modal.appendChild(this.prompt_input_wrapper),
      "stop" != e._type && this.modal.appendChild(this.buttons),
      this.el.appendChild(this.modal);
  }
  function n(e) {
    (this.el = document.createElement("div")),
      (this.el.className = "pdtoast_wrapper is_showing is_changing"),
      (this.el.style.zIndex = PdMessage.prototype.index),
      (PdMessage.prototype.index += 2),
      (this.toast = document.createElement("div"));
    var t = "toast";
    e.type && (t = t + " " + e.type),
      (this.toast.className = t),
      this.toast.appendChild(
        document.createTextNode(e.toast || "toast内容未定义！")
      ),
      this.el.appendChild(this.toast);
  }
  function o(e) {
    (this.el = document.createElement("div")),
      (this.el.className = "pdactionsheet_wrapper is_showing is_changing"),
      ...
      (this.actionsheet.className = "pdactionsheet_actionsheet"),
      (this.actions = document.createElement("div")),
      (this.actions.className = "pdactionsheet_actions"),
      (e.title || e.message) &&
        ((this.titlewrapper = document.createElement("div")),
        (this.titlewrapper.className = "pdactionsheet_titlewrapper"),
        (this.title = document.createElement("div")),
        (this.title.className = "pdactionsheet_title"),
        this.title.appendChild(document.createTextNode(e.title || "")),
        this.titlewrapper.appendChild(this.title),
        (this.message = document.createElement("div")),
        (this.message.className = "pdactionsheet_message"),
        this.message.appendChild(document.createTextNode(e.message || "")),
        this.titlewrapper.appendChild(this.message),
        this.actions.appendChild(this.titlewrapper)),
      (this.actionswrapper = document.createElement("div")),
      (this.actionswrapper.className = "pdactionsheet_actionswrapper"),
      this.actions.appendChild(this.actionswrapper);
    for (var t = 0; t < e.actions.length; t++) {
      var n = e.actions[t],
        i = document.createElement("button");
      (i.className = n.type || ""),
        i.appendChild(document.createTextNode(n.name || "按钮名称未定义")),
        i.addEventListener("click", n.command),
        this.actionswrapper.appendChild(i);
    }
    (this.cancel = document.createElement("button")),
      (this.cancel.className = "pdactionsheet_cancel"),
      this.cancel.appendChild(document.createTextNode(e.cancel || "取消")),
      this.actionsheet.appendChild(this.actions),
      this.actionsheet.appendChild(this.cancel),
      this.el.appendChild(this.actionsheet);
  }
  function s(e) {
    (this.el = document.createElement("div")),
      (this.el.className = "pdnotify_wrapper"),
      (this.notify = document.createElement("div"));
    var t = "pdnotify";
    e.type && (t = t + " " + e.type),
      (this.notify.className = t),
      (this.notifySpan = document.createElement("span")),
      this.notifySpan.appendChild(
        document.createTextNode(e.notify || "notify内容未定义！")
      ),
      this.notify.appendChild(this.notifySpan),
      this.el.appendChild(this.notify);
  }
  (PdMessage.prototype.index = PdMessage.prototype.index || 8001),
    (PdMessage.prototype.Modal_background_instance =
      PdMessage.prototype.Modal_background_instance ||
      new (function () {
        (this.el = document.createElement("div")),
          (this.el.className = "pdModal_background is_showing is_changing");
      })()),
    (PdMessage.prototype.model_zIndexs =
      PdMessage.prototype.model_zIndexs || []),
    (this.message_is_show = !1),
    (this.MessageInstance = void 0),
    (this.confirm = function (n) {
      if (
        ...
        !this.message_is_show)
      )
        return (
          (this.message_is_show = !0),
          (this.timing = n.timing || 350),
          t(!0),
          n.then || n.catch
            ? ((n._type = "confirm"),
              (this.MessageInstance = new i(n)),
              document.body.appendChild(r.MessageInstance.el),
              window.setTimeout(function () {
    ...
    (this.stop = function (e) {
      if (
        ...
        return (
          (this.message_is_show = !0),
          (this.timing = e.timing || 350),
          (e._type = "stop"),
          t(!0),
          (this.MessageInstance = new i(e)),
          document.body.appendChild(r.MessageInstance.el),
          window.setTimeout(function () {
            r.MessageInstance.el.className = "pdmsg_wrapper";
          }, 16),
    ...
    (this.closeMessage = function () {
      this.message_is_show
        ? (t(
            (this.message_is_show = !1),
            parseInt(this.MessageInstance.el.style.zIndex)
          ),
          (this.MessageInstance.el.className =
            "pdmsg_wrapper is_disappearing is_changing"),
          window.setTimeout(function () {
            r.MessageInstance.el.parentNode.removeChild(r.MessageInstance.el);
          }, r.timing))
        : console.log("is NOT on show!");
    }),
    (this.ToastInstance = void 0),
    (this.toast = function (e) {
      ...
      (this.timing = e.timing || 350),
        (this.ToastInstance = new n(e)),
        document.body.appendChild(this.ToastInstance.el),
        window.setTimeout(function () {
          (r.ToastInstance.el.className = "pdtoast_wrapper"),
            window.setTimeout(function () {
              r.closeToast();
            }, e.duration || 2e3);
        }, e.timing || 16);
    ...
    (this.closeToast = function () {
      (this.ToastInstance.el.className =
        "pdtoast_wrapper is_disappearing is_changing"),
        window.setTimeout(function () {
          r.ToastInstance.el.parentNode.removeChild(r.ToastInstance.el);
        }, r.timing);
    }),
    (this.ActionsheetInstance = void 0),
    (this.actionsheeet_is_show = !1),
    (this.initActionsheet = function (e) {
      null != e.length &&
        (e = {
          actions: e,
        }),
        (this.actionsheeet_is_show = !0),
        (this.timing = e.timing || 300),
        t(!0),
        (this.ActionsheetInstance = new o(e)),
    ...
    (this.closeActionsheet = function () {
      this.actionsheeet_is_show &&
        (t(
          (this.actionsheeet_is_show = !1),
          parseInt(this.ActionsheetInstance.el.style.zIndex)
        ),
        (this.ActionsheetInstance.el.className =
          "pdactionsheet_wrapper is_disappearing is_changing"),
        window.setTimeout(function () {
          r.ActionsheetInstance.el.parentNode.removeChild(
            r.ActionsheetInstance.el
          );
        }, r.timing));
    }),
    (this.NotifyInstance = void 0),
    (PdMessage.prototype.notify_queue = PdMessage.prototype.notify_queue || []),
    (PdMessage.prototype.notify_queue_is_showing =
      PdMessage.prototype.notify_queue_is_showing || !1),
    (this.notify = function (e) {
      ...
      PdMessage.prototype.notify_queue.push(e),
        PdMessage.prototype.notify_queue_is_showing || this.notify_queue_show();
    }),
    ...
    (this.showNotify = function (e) {
      if (
        ((this.timing = e.timing || 500),
        (this.NotifyInstance = new s(e)),
        !document.getElementById("pdnotify_container"))
      ) {
        var t = document.createElement("div");
        t.setAttribute("id", "pdnotify_container"),
      ...
      (this.NotifyInstance.el.style.height = i + "px"),
        this.NotifyInstance.el.parentNode.removeChild(this.NotifyInstance.el),
        (this.NotifyInstance.el.className =
          "pdnotify_wrapper is_showing is_changing"),
        n.appendChild(this.NotifyInstance.el),
        window.setTimeout(function () {
          (r.NotifyInstance.el.className = "pdnotify_wrapper"),
            window.setTimeout(function () {
              r.closeNotify();
            }, e.duration || 5e3);
        }, e.timing || 16);
    ...
    (this.closeNotify = function () {
      (this.NotifyInstance.el.className =
        "pdnotify_wrapper is_disappearing is_changing"),
        window.setTimeout(function () {
...
if (
  ((function (e, t) {
          ...
          for (
            ...
            if (null != (e = arguments[a]))
              for (t in e)
                (n = s[t]),
                  s !== (i = e[t]) &&
                    (c && i && (C.isPlainObject(i) || (o = C.isArray(i)))
                      ? ((r = o
                          ? ((o = !1), n && C.isArray(n) ? n : [])
                          : n && C.isPlainObject(n)
                          ? n
        ...
        globalEval: function (e) {
          ...
          (e = C.trim(e)) &&
            (1 === e.indexOf("use strict")
              ? (((t = b.createElement("script")).text = e),
                b.head.appendChild(t).parentNode.removeChild(t))
              : n(e));
        },
    ...
    var p = (function (n) {
      ...
      try {
        B.apply((t = L.call(E.childNodes)), E.childNodes),
        ...
        if (v && !i) {
          if ((o = G.exec(e)))
            if ((s = o[1])) {
              ...
              if (o[2]) return B.apply(n, t.getElementsByTagName(e)), n;
              if (
                (s = o[3]) &&
          ...
          if (f.qsa && (!b || !b.test(e))) {
            ...
            if (p)
              try {
                return B.apply(n, h.querySelectorAll(p)), n;
              } catch (e) {
              } finally {
            ...
            for (
              ...
              if (
                ...
                (i = l(
                  ...
                  (K.test(r[0].type) && ue(t.parentNode)) || t
                ))
              ) {
                if ((r.splice(o, 1), !(e = i.length && pe(r))))
          ...
          return l !== x && 9 === l.nodeType && l.documentElement
            ? ((o = (x = l).documentElement),
              ...
              (w.find.CLASS =
                f.getElementsByClassName &&
                function (e, t) {
                  return typeof t.getElementsByClassName !== $ && v
                    ? t.getElementsByClassName(e)
                    : void 0;
                }),
              (s = []),
              (b = []),
              (f.qsa = Y.test(l.querySelectorAll)) &&
                (oe(function (e) {
                  (e.innerHTML =
              ...
              (t = Y.test(o.compareDocumentPosition)),
              (y =
                t || Y.test(o.contains)
                  ? function (e, t) {
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      (!f.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === l || (e.ownerDocument === E && y(E, e))
                          ? -1
                          : t === l || (t.ownerDocument === E && y(E, t))
                          ? 1
                          : c
                          ? I.call(c, e) - I.call(c, t)
                          : 0
                        : 4 & n
                        ? -1
                        : 1)
      ...
      (te.matchesSelector = function (e, t) {
        if (
          ...
          (t = t.replace(W, "='$1']")),
          !(!f.matchesSelector || !v || (s && s.test(t)) || (b && b.test(t))))
        )
          try {
            var n = a.call(e, t);
            if (
      ...
      (te.attr = function (e, t) {
        ...
        var n = w.attrHandle[t.toLowerCase()],
          i = n && N.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !v) : void 0;
        return void 0 !== i
          ? i
          : f.attributes || !v
          ? e.getAttribute(t)
      ...
      ((w = te.selectors =
        {
          ...
          pseudos: {
            ...
            lang: ie(function (n) {
              return (
                U.test(n || "") || te.error("unsupported lang: " + n),
        ...
        return (
          ...
          ie(function (e, t, n, i) {
            var o,
              ...
              d = !p || (!e && f) ? u : ge(u, a, p, n, i),
              h = m ? (v || (e ? p : c || g) ? [] : t) : d;
            if ((m && m(d, h, n, i), g))
              for (o = ge(h, l), g(o, [], n, i), r = o.length; r--; )
                (s = o[r]) && (h[l[r]] = !(d[l[r]] = s));
            if (e) {
              if (v || p) {
                if (v) {
                ...
                for (r = h.length; r--; )
                  (s = h[r]) &&
                    -1 < (o = v ? I.call(e, s) : a[r]) &&
                    (e[o] = !(t[o] = s));
              }
            } else (h = ge(h === t ? h.splice(c, h.length) : h)), v ? v(null, t, h, i) : B.apply(t, h);
          })
        );
      }
      function be(e) {
        for (
          ...
          if ((t = w.relative[e[a].type])) u = [fe(me(u), t)];
          else {
      ...
      return (
        ...
        (m = te.compile =
          function (e, t) {
            var n,
              ...
              s = p[e + " "];
            if (!s) {
              for (t || (t = he(e)), n = t.length; n--; )
                (s = be(t[n]))[C] ? o.push(s) : r.push(s);
              s = p(
                e,
                ((g = r),
                (b = 0 < (v = o).length),
        ...
        (f.sortStable = C.split("").sort(k).join("") === C),
        (f.detectDuplicates = !!u),
        g(),
        (f.sortDetached = oe(function (e) {
    ...
    (C.filter = function (e, t, n) {
      ...
      C.fn.extend({
        find: function (e) {
          ...
          return (
            ((i = this.pushStack(1 < n ? C.unique(i) : i)).selector = this
              .selector
              ? this.selector + " " + e
              : e),
            i
        ...
        is: function (e) {
          return !!x(
            this,
            "string" == typeof e && y.test(e) ? C(e) : e || [],
            !1
          ).length;
        },
      });
    ...
    ((C.fn.init = function (e, t) {
      ...
      if (n[1]) {
        if (
          ...
          C.merge(
            this,
            C.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : b, !0)
          ),
          w.test(n[1]) && C.isPlainObject(t))
        )
          for (n in t)
        ...
        closest: function (e, t) {
          for (
            var n,
              ...
              r = [],
              s =
                y.test(e) || "string" != typeof e ? C(e, t || this.context) : 0;
            i < o;
            i++
          )
        ...
        function (i, o) {
          C.fn[i] = function (e, t) {
            ...
            return (
              ...
              1 < this.length &&
                ($[i] || C.unique(n), k.test(i) && n.reverse()),
              this.pushStack(n)
            );
          };
        }
    ...
    function L() {
      b.removeEventListener("DOMContentLoaded", L, !1),
    ...
    (C.Callbacks = function (o) {
      ...
      var t,
        ...
        d = function (e) {
          for (
            t = o.memory && e, i = !0, l = s || 0, s = 0, a = c.length, r = !0;
            c && l < a;
            l++
          )
          ...
          (r = !1),
            c && (u ? u.length && d(u.shift()) : t ? (c = []) : h.disable());
        },
        h = {
          add: function () {
            if (c) {
              ...
              !(function i(e) {
                C.each(e, function (e, t) {
                  var n = C.type(t);
                  "function" === n
                    ? (o.unique && h.has(t)) || c.push(t)
                    : t && t.length && "string" !== n && i(t);
                });
              })(arguments),
                r ? (a = c.length) : t && ((s = e), d(t));
            }
            return this;
          },
          remove: function () {
          ...
          return (
            ...
            C.each(r, function (e, t) {
              ...
              (s[t[1]] = n.add),
                ...
                (a[t[0]] = function () {
                  return (
                    a[t[0] + "With"](this === a ? s : this, arguments), this
                  );
                }),
      ...
      C.extend({
        ...
        ready: function (e) {
          (!0 === e ? --C.readyWait : C.isReady) ||
            ...
            (S.resolveWith(b, [C]),
            C.fn.trigger && C(b).trigger("ready").off("ready"));
        },
      }),
        ...
        return (
          S ||
            ...
            "complete" === b.readyState
              ? setTimeout(C.ready)
              : (b.addEventListener("DOMContentLoaded", L, !1),
                f.addEventListener("load", L, !1))),
          S.promise(e)
        );
      }),
      C.ready.promise();
    var I = (C.access = function (e, t, n, i, o, r, s) {
      var a = 0,
        l = e.length,
        c = null == n;
      if ("object" === C.type(n))
        for (a in ((o = !0), n)) C.access(e, t, a, n[a], !0, r, s);
      else if (
        void 0 !== i &&
        ((o = !0),
        C.isFunction(i) || (s = !0),
        ...
        remove: function (e, t) {
          ...
          if (void 0 === t) this.cache[r] = {};
            ...
            n = (i = C.isArray(t)
              ...
              : ((o = C.camelCase(t)),
                t in s ? [t, o] : (i = o) in s ? [i] : i.match(A) || []))
              .length;
            for (; n--; ) delete s[i[n]];
          }
        },
    ...
    C.extend({
      ...
      C.fn.extend({
        data: function (i, e) {
              ...
              : I(
                  ...
                  function (t) {
                    var e,
                      n = C.camelCase(i);
                    if (r && void 0 === t) {
                      if (void 0 !== (e = P.get(r, i))) return e;
                      if (void 0 !== (e = P.get(r, n))) return e;
          ...
          if (
            this.length &&
            ((o = P.get(r)), 1 === r.nodeType && !M.get(r, "hasDataAttrs"))
          ) {
            for (t = s.length; t--; )
              0 === (n = s[t].name).indexOf("data-") &&
                ((n = C.camelCase(n.slice(5))), R(r, n, o[n]));
    ...
    ((H = b
      ...
      .appendChild(b.createElement("div"))).innerHTML =
    ...
    (C.event = {
      ...
      remove: function (e, t, n, i, o) {
        ...
        if (g && (l = g.events)) {
          ...
          C.isEmptyObject(l) && (delete g.handle, M.remove(e, "events"));
        }
      },
      trigger: function (e, t, n, i) {
        ...
        if (
          ...
          if (!i && !u.noBubble && !C.isWindow(n)) {
            for (
              a = u.delegateType || h, V.test(a + h) || (r = r.parentNode);
              r;
              r = r.parentNode
            )
              d.push(r), (s = r);
            s === (n.ownerDocument || b) &&
              d.push(s.defaultView || s.parentWindow || f);
          }
          for (o = 0; (r = d[o++]) && !e.isPropagationStopped(); )
            (e.type = 1 < o ? a : u.bindType || h),
              (c = (M.get(r, "events") || {})[e.type] && M.get(r, "handle")) &&
                c.apply(r, t),
              (c = l && r[l]) &&
                c.apply &&
                C.acceptData(r) &&
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            s = C.event.handlers.call(this, e, l), t = 0;
      ...
      fix: function (e) {
        ...
        for (
          s ||
            (this.fixHooks[o] = s =
              X.test(o) ? this.mouseHooks : Q.test(o) ? this.keyHooks : {}),
          ...
          function (n, i) {
            ...
            C.event.special[i] = {
              ...
              teardown: function () {
                ...
                t
                  ? M.access(e, i, t)
                  : (e.removeEventListener(n, o, !0), M.remove(e, i));
              },
            };
          }
        ),
    ...
    function he(e, t) {
      ...
      if (1 === t.nodeType) {
        if (
          M.hasData(e) &&
          ((r = M.access(e)), (s = M.set(t, r)), (c = r.events))
        )
          for (o in (delete s.handle, (s.events = {}), c))
            for (n = 0, i = c[o].length; n < i; n++) C.event.add(t, o, c[o][n]);
        P.hasData(e) && ((a = P.access(e)), (l = C.extend({}, a)), P.set(t, l));
      }
    }
    function pe(e, t) {
    ...
    (ae.optgroup = ae.option),
      ...
      C.extend({
        clone: function (e, t, n) {
          ...
          if (
            ...
            for (s = pe(u), i = 0, o = (r = pe(e)).length; i < o; i++)
              (a = r[i]),
                (l = s[i]),
                void 0,
                "input" === (c = l.nodeName.toLowerCase()) && F.test(a.type)
                  ? (l.checked = a.checked)
                  : ("input" === c || "textarea" === c) &&
          ...
          return (
            0 < (s = pe(u, "script")).length && de(s, !d && pe(e, "script")), u
          );
        },
              ...
              if ("object" === C.type(o)) C.merge(d, o.nodeType ? [o] : o);
                ...
                for (
                  r = r || u.appendChild(t.createElement("div")),
                    ...
                    a = ae[s] || ae._default,
                    r.innerHTML = a[1] + o.replace(J, "<$1></$2>") + a[2],
                    c = a[0];
                  c--;
        ...
        cleanData: function (e) {
          for (
            var t, n, i, o, r, s, a = C.event.special, l = 0;
            void 0 !== (n = e[l]);
            l++
          ) {
            if (C.acceptData(n) && (r = n[M.expando]) && (t = M.cache[r])) {
              if ((i = Object.keys(t.events || {})).length)
                for (s = 0; void 0 !== (o = i[s]); s++)
                  a[o] ? C.event.remove(n, o) : C.removeEvent(n, o, t.handle);
      ...
      C.fn.extend({
        ...
        remove: function (e, t) {
          for (
            var n, i = e ? C.filter(e, this) : this, o = 0;
            null != (n = i[o]);
            o++
          )
            t || 1 !== n.nodeType || C.cleanData(pe(n)),
              n.parentNode &&
                (t && C.contains(n.ownerDocument, n) && de(pe(n, "script")),
        ...
        domManip: function (n, i) {
          ...
          if (
            p ||
            (1 < c && "string" == typeof h && !v.checkClone && ie.test(h))
          )
          ...
          if (
            ...
            for (r = (o = C.map(pe(e, "script"), ce)).length; l < c; l++)
              (s = e),
                l !== d &&
                  ((s = C.clone(s, !0, !0)), r && C.merge(o, pe(s, "script"))),
                i.call(this[l], s, l);
            if (r)
              for (
                a = o[o.length - 1].ownerDocument, C.map(o, ue), l = 0;
                l < r;
                l++
              )
                (s = o[l]),
                  oe.test(s.type || "") &&
                    !M.access(s, "globalEval") &&
                    C.contains(a, s) &&
                    (s.src
                      ? C._evalUrl && C._evalUrl(s.src)
                      : C.globalEval(s.textContent.replace(se, "")));
          }
          return this;
        },
      }),
    ...
    function ge(e, t) {
      var n = C(t.createElement(e)).appendTo(t.body),
        i = f.getDefaultComputedStyle
          ? f.getDefaultComputedStyle(n[0]).display
          : C.css(n[0], "display");
      return n.detach(), i;
    }
    function ve(e) {
      ...
      return (
        n ||
          (("none" !== (n = ge(e, t)) && n) ||
            ((t = (fe = (
              fe || C("<iframe frameborder='0' width='0' height='0'/>")
        ...
        f.getComputedStyle &&
          C.extend(v, {
            ...
            reliableMarginRight: function () {
              var e,
                t = r.appendChild(b.createElement("div"));
              return (
    ...
    function Be(e, t, n, i, o) {
      for (
        ...
        "margin" === n && (s += C.css(e, n + z[r], !0, o)),
          i
            ? ("content" === n && (s -= C.css(e, "padding" + z[r], !0, o)),
              "margin" !== n &&
                (s -= C.css(e, "border" + z[r] + "Width", !0, o)))
            : ((s += C.css(e, "padding" + z[r], !0, o)),
              "padding" !== n &&
                (s += C.css(e, "border" + z[r] + "Width", !0, o)));
      return s;
    }
    function Le(e, t, n) {
      ...
      if (o <= 0 || null == o) {
        if (
          (((o = _e(e, t, r)) < 0 || null == o) && (o = e.style[t]), ye.test(o))
        )
          return o;
    ...
    function Ie(e, t) {
      for (var n, i, o, r = [], s = 0, a = e.length; s < a; s++)
        (i = e[s]).style &&
          ((r[s] = M.get(i, "olddisplay")),
          (n = i.style.display),
          t
            ? (r[s] || "none" !== n || (i.style.display = ""),
              "" === i.style.display &&
                W(i) &&
                (r[s] = M.access(i, "olddisplay", ve(i.nodeName))))
            : r[s] ||
              ((o = W(i)),
              ((n && "none" !== n) || !o) &&
                M.set(i, "olddisplay", o ? n : C.css(i, "display"))));
      for (s = 0; s < a; s++)
        (i = e[s]).style &&
    ...
    function De(e, t, n, i, o) {
      return new De.prototype.init(e, t, n, i, o);
    }
    C.extend({
      cssHooks: {
        opacity: {
      ...
      style: function (e, t, n, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
            ...
            l = e.style;
          return (
            (t = C.cssProps[a] || (C.cssProps[a] = Se(l, a))),
      ...
      css: function (e, t, n, i) {
        var o,
          ...
          a = C.camelCase(t);
        return (
          (t = C.cssProps[a] || (C.cssProps[a] = Se(e.style, a))),
          (s = C.cssHooks[t] || C.cssHooks[a]) &&
            "get" in s &&
            (o = s.get(e, !0, n)),
          void 0 === o && (o = _e(e, t, i)),
      ...
      C.each(["height", "width"], function (e, o) {
        C.cssHooks[o] = {
          get: function (e, t, n) {
            return t
              ? 0 === e.offsetWidth && Ce.test(C.css(e, "display"))
                ? C.swap(e, ke, function () {
                    return Le(e, o, n);
                  })
                : Le(e, o, n)
              : void 0;
          ...
          (C.cssHooks[o + r] = {
            expand: function (e) {
              for (
                ...
                n[o + z[t] + r] = i[t] || i[t - 2] || i[0];
              return n;
            },
          }),
            be.test(o) || (C.cssHooks[o + r].set = Ae);
        }
      ),
      C.fn.extend({
        css: function (e, t) {
      ...
      We = [
        function (t, e, n) {
          ...
          1 === t.nodeType &&
            ...
            "none" === (c = C.css(t, "display")) && (c = ve(t.nodeName)),
            "inline" === c &&
              "none" === C.css(t, "float") &&
          ...
          if (!C.isEmptyObject(d))
            ...
            u.done(function () {
              var e;
              for (e in (M.remove(t, "fxshow"), d)) C.style(t, e, d[e]);
            }),
            d))
              (s = Xe(p ? f[i] : 0, i, u)),
                i in f ||
        ...
        "*": [
          function (e, t) {
            var n = this.createTween(e, t),
              ...
              s =
                (C.cssNumber[e] || ("px" !== r && +i)) &&
                qe.exec(C.css(n.elem, e)),
              a = 1,
              l = 20;
            if (s && s[3] !== r)
              for (
    ...
    function Xe(e, t, n) {
      for (
        var i, o = (Fe[t] || []).concat(Fe["*"]), r = 0, s = o.length;
        r < s;
        r++
      )
    ...
    function Ve(r, e, t) {
      ...
      for (
        ...
        if ((n = We[i].call(c, r, u, c.opts))) return n;
      return (
        C.map(u, Xe, c),
    ...
    (C.Animation = C.extend(Ve, {
      tweener: function (e, t) {
        for (
          ...
          (n = e[i]), (Fe[n] = Fe[n] || []), Fe[n].unshift(t);
      },
        ...
        stop: function (o, e, r) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (t in i) i[t] && i[t].stop && ze.test(t) && s(i[t]);
              for (t = n.length; t--; )
                n[t].elem !== this ||
                  (null != o && n[t].queue !== o) ||
      ...
      (C.fx.tick = function () {
        var e,
          t = 0,
          n = C.timers;
        for (Me = C.now(); t < n.length; t++)
          (e = n[t])() || n[t] !== e || n.splice(t--, 1);
        n.length || C.fx.stop(), (Me = void 0);
      }),
      ...
      (je = b.createElement("input")),
      (Oe = b.createElement("select")),
      (Re = Oe.appendChild(b.createElement("option"))),
      (je.type = "checkbox"),
      (v.checkOn = "" !== je.value),
      (v.optSelected = Re.selected),
      (Oe.disabled = !0),
      (v.optDisabled = !Re.disabled),
      ((je = b.createElement("input")).value = "t"),
      (je.type = "radio"),
      ...
      C.extend({
          ...
          if (e && 3 !== r && 8 !== r && 2 !== r)
            return typeof e.getAttribute === U
              ...
              : ((1 === r && C.isXMLDoc(e)) ||
                  ...
                  (i =
                    C.attrHooks[t] ||
                    (C.expr.match.bool.test(t) ? Ye : void 0))),
                void 0 === n
        ...
        removeAttr: function (e, t) {
          ...
          if (r && 1 === e.nodeType)
            for (; (n = r[o++]); )
              (i = C.propFix[n] || n),
                C.expr.match.bool.test(n) && (e[i] = !1),
                e.removeAttribute(n);
        },
        attrHooks: {
          type: {
          ...
          : this.each(
              C.isFunction(o)
                ...
                : function () {
                    if ("string" === r)
                      for (
                        var e, t = 0, n = C(this), i = o.match(A) || [];
                        (e = i[t++]);
          ...
          select: {
            ...
            set: function (e, t) {
              for (
                ...
                ((i = o[s]).selected = 0 <= C.inArray(C(i).val(), r)) &&
                  (n = !0);
    ...
    (nt = ct.exec(it.toLowerCase()) || []),
      C.extend({
        ...
        ajax: function (e, t) {
          ...
          m.hasContent ||
            (m.data &&
              ((d = m.url += (tt.test(d) ? "&" : "?") + m.data), delete m.data),
            !1 === m.cache &&
              (m.url = rt.test(d)
                ? d.replace(rt, "$1_=" + et++)
                : d + (tt.test(d) ? "&" : "?") + "_=" + et++)),
          m.ifModified &&
            (C.lastModified[d] &&
              x.setRequestHeader("If-Modified-Since", C.lastModified[d]),
          ...
          function l(e, t, n, i) {
            ...
            2 !== _ &&
              ...
              o
                ? (m.ifModified &&
                    ((l = x.getResponseHeader("Last-Modified")) &&
                      (C.lastModified[d] = l),
                    (l = x.getResponseHeader("etag")) && (C.etag[d] = l)),
                  204 === e || "HEAD" === m.type
                    ? (c = "nocontent")
                    : 304 === e
                    ? (c = "notmodified")
              ...
              (x.status = e),
              (x.statusText = (t || c) + ""),
              o ? b.resolveWith(g, [r, c, x]) : b.rejectWith(g, [x, c, s]),
              x.statusCode(w),
              (w = void 0),
              f &&
                v.trigger(o ? "ajaxSuccess" : "ajaxError", [x, m, o ? r : s]),
              y.fireWith(g, [x, c]),
              f &&
    ...
    f.ActiveXObject &&
      ...
      (v.cors = !!Tt && "withCredentials" in Tt),
      (v.ajax = Tt = !!Tt),
    ...
    (C.offset = {
          ...
          if (this[0]) {
            ...
            return (
              "fixed" === C.css(n, "position")
                ...
                : ((e = this.offsetParent()),
                  (t = this.offset()),
                  C.nodeName(e[0], "html") || (i = e.offset()),
                  (i.top += C.css(e[0], "borderTopWidth", !0)),
                  (i.left += C.css(e[0], "borderLeftWidth", !0))),
              {
              ...
              function (e, t, n) {
                ...
                return void 0 === n
                  ? i
                    ...
                    : e[t]
                  : void (i
                      ? i.scrollTo(r ? f.pageXOffset : n, r ? n : f.pageYOffset)
                      : (e[t] = n));
              },
              t,
              e,
      ...
      C.each(["top", "left"], function (e, n) {
        C.cssHooks[n] = xe(v.pixelPosition, function (e, t) {
          return t
            ? ((t = _e(e, n)), ye.test(t) ? C(e).position()[n] + "px" : t)
            : void 0;
        });
      }),
      C.each(
    ...
    return (
      (C.noConflict = function (e) {
        return (
          f.$ === C && (f.$ = Lt), e && f.jQuery === C && (f.jQuery = Bt), C
        );
      }),
      typeof e === U && (f.jQuery = f.$ = C),
      C
    );
  }),
  (function (t, n, i) {
    "function" == typeof define && define.amd
      ...
      : i(t.jQuery, t, n);
  })(this, document, function (e, S, A, t) {
    ...
    (function (c, u, e) {
        ...
        (t = (function () {
          function n() {
            var e = d(),
              t = l(r);
            e !== r
              ? (a((r = e), t), c(u).trigger(h))
              : t !== r &&
                (location.href = location.href.replace(/#.*/, "") + t),
              (i = setTimeout(n, c.fn[h].delay));
          }
          var i,
            o,
            e,
          ...
          return (
            ...
            u.attachEvent &&
              ...
              ((t.start = function () {
                o ||
                  ((e = (e = c.fn[h].src) && e + d()),
                  (o = c('<iframe tabindex="-1" title="empty"/>')
                    .hide()
                    .one("load", function () {
                      e || a(d()), n();
                    })
              ...
              (a = function (e, t) {
                ...
                e !== t &&
                  ((n.title = p.title),
                  n.open(),
                  i && n.write('<script>document.domain="' + i + '"</script>'),
                  n.close(),
                  (o.location.hash = e));
              })),
            t
      ...
      b.extend(b.mobile, {
        ...
        getAttribute: function (e, t) {
          ...
          (e = e.jquery ? e[0] : e) &&
            e.getAttribute &&
            (n = e.getAttribute("data-" + b.mobile.ns + t));
          try {
            n =
              "true" === n ||
              ("false" !== n &&
      ...
      (b.fn.jqmData = function (e, t) {
        ...
        return (
          void 0 !== e &&
            (e && (e = b.mobile.nsNormalize(e)),
            (n =
              arguments.length < 2 || void 0 === t
                ? this.data(e)
                : this.data(e, t))),
          n
        );
      ...
      (b.jqmData = function (e, t, n) {
        var i;
        return (
          void 0 !== t && (i = b.data(e, t ? b.mobile.nsNormalize(t) : t, n)), i
        );
      }),
      ...
      (b.find = function (e, t, n, i) {
        return (
          -1 < e.indexOf(":jqmData") &&
            (e = e.replace(x, "[data-" + (b.mobile.ns || "") + "$1]")),
          w.call(this, e, t, n, i)
        );
      }),
      b.extend(b.find, w),
      (function (a, e) {
        ...
        (a.ui = a.ui || {}),
                ...
                return (
                  a.each(o, function () {
                    (t -= parseFloat(a.css(e, "padding" + this)) || 0),
                      n &&
                        (t -=
                          parseFloat(a.css(e, "border" + this + "Width")) || 0),
          ...
          (a.support.selectstart = "onselectstart" in A.createElement("div")),
          a.fn.extend({
            ...
            zIndex: function (e) {
              ...
              if (this.length)
                for (var t, n, i = a(this[0]); i.length && i[0] !== A; ) {
                  if (
      ...
      (g = e).extend(g.mobile, {
        ...
        silentScroll: function (e) {
          "number" !== g.type(e) && (e = g.mobile.defaultHomeScroll),
            (g.event.special.scrollstart.enabled = !1),
            setTimeout(function () {
              v.scrollTo(0, e),
        ...
        getClosestBaseUrl: function (e) {
          ...
          return (
            (g.mobile.dynamicBaseEnabled && t && g.mobile.path.isPath(t)) ||
              (t = n),
            g.mobile.path.makeUrlAbsolute(t, n)
          );
        },
        removeActiveLinkClass: function (e) {
          !!g.mobile.activeClickedLink &&
            (!g.mobile.activeClickedLink.closest("." + g.mobile.activePageClass)
              .length ||
              e) &&
        ...
        getInheritedTheme: function (e, t) {
          for (
            var n, i, o = e[0], r = "", s = /ui-(bar|body|overlay)-([a-z])\b/;
            o && !((n = o.className || "") && (i = s.exec(n)) && (r = i[2]));
          ...
          for (r = 0; r < s; r++) {
            for (i = e.eq(r), o = !1, n = e[r]; n; ) {
              if (
                "false" ===
                (n.getAttribute
                  ? n.getAttribute("data-" + g.mobile.ns + t)
                  : "")
              ) {
                o = !0;
                break;
        ...
        resetActivePageHeight: function (e) {
          var t,
            ...
            l,
            c,
            u = g("." + g.mobile.activePageClass),
            d = u.height(),
            h = u.outerHeight(!0);
          (t = u),
            (n = "number" == typeof e ? e : g.mobile.getScreenHeight()),
            (i = t.parent()),
            (o = []),
            (r = function () {
              var e = g(this),
                t =
                  g.mobile.toolbar && e.data("mobile-toolbar")
                    ? e.toolbar("option")
                    : {
                        position: e.attr("data-" + g.mobile.ns + "position"),
                        updatePagePadding:
                          !1 !==
                          e.attr("data-" + g.mobile.ns + "update-page-padding"),
                      };
              return "fixed" !== t.position || !0 !== t.updatePagePadding;
            }),
            (s = i.children(":jqmData(role='header')").filter(r)),
            (a = t.children(":jqmData(role='header')")),
            (l = i.children(":jqmData(role='footer')").filter(r)),
            (c = t.children(":jqmData(role='footer')")),
            0 === a.length && 0 < s.length && (o = o.concat(s.toArray())),
            0 === c.length && 0 < l.length && (o = o.concat(l.toArray())),
            g.each(o, function (e, t) {
              n -= g(t).outerHeight();
            }),
            (e = Math.max(0, n)),
            u.css("min-height", ""),
            u.height() < e && u.css("min-height", e - (h - d));
        },
        loading: function () {
          var e =
              this.loading._widget ||
              g(g.mobile.loader.prototype.defaultHtml).loader(),
      ...
      g.fn.extend({
        ...
        enhanceWithin: function () {
          var e,
            ...
            r = this;
          for (e in (g.mobile.nojs && g.mobile.nojs(this),
          g.mobile.links && g.mobile.links(this),
          g.mobile.degradeInputsWithin && g.mobile.degradeInputsWithin(this),
          g.fn.buttonMarkup &&
            this.find(g.fn.buttonMarkup.initSelector)
              .not(o)
              .jqmEnhanceable()
              .buttonMarkup(),
          g.fn.fieldcontain &&
          ...
          g.each(g.mobile.widgets, function (e, t) {
            if (t.initSelector) {
              ...
              0 < n.length && (n = n.not(o)),
                0 < n.length && (i[t.prototype.widgetName] = n);
            }
          }),
          i))
            i[e][e]();
      ...
      (S.matchMedia =
        S.matchMedia ||
        ((h = (u = A).documentElement),
        (p = h.firstElementChild || h.firstChild),
        (f = u.createElement("body")),
        ((m = u.createElement("div")).id = "mq-test-1"),
      ...
      ((a = e).mobile.support = a.mobile.support || {}),
      a.extend(a.support, l),
      a.extend(a.mobile.support, l),
      (s = e).extend(s.support, {
      ...
      (function (r, e) {
        function t(e) {
          ...
          for (t in i) if (void 0 !== E[i[t]]) return !0;
        }
        var n,
          i,
          o,
          ...
          _,
          x,
          C = r("<body>").prependTo("html"),
          E = C[0].style,
          T = ["Webkit", "Moz", "O"],
          k = "palmGetResource" in S,
          $ =
            S.operamini &&
            "[object OperaMini]" === {}.toString.call(S.operamini),
          N = S.blackberry && !t("-webkit-transform");
        r.extend(r.mobile, {
          browser: {},
        }),
          (r.mobile.browser.oldIE = (function () {
            for (
              var e = 3, t = A.createElement("div"), n = t.all || [];
              (t.innerHTML =
                "\x3c!--[if gt IE " + ++e + "]><br><![endif]--\x3e"),
                n[0];
          ...
          r.extend(r.support, {
            pushState:
              ...
              !(0 <= S.navigator.userAgent.indexOf("Firefox") && S.top !== S) &&
              -1 === S.navigator.userAgent.search(/CriOS/),
            ...
            cssTransform3d: (function () {
              ...
              if (o) return !!o;
              for (n in ((e = A.createElement("div")),
              (t = {
              ...
              t))
                void 0 !== e.style[n] &&
                  ((e.style[n] = "translate3d( 100px, 1px, 1px )"),
                  (o = S.getComputedStyle(e).getPropertyValue(t[n])));
              return !!o && "none" !== o;
            })(),
            boxShadow: !!t("boxShadow") && !N,
            fixedPosition:
              ((f = S),
              (m = navigator.userAgent),
              (g = navigator.platform),
              (v = m.match(/AppleWebKit\/([0-9]+)/)),
              (b = !!v && v[1]),
              (y = m.match(/Fennec\/([0-9]+)/)),
              (w = !!y && y[1]),
              (_ = m.match(/Opera Mobi\/([0-9]+)/)),
              (x = !!_ && _[1]),
              !(
                ((-1 < g.indexOf("iPhone") ||
                  -1 < g.indexOf("iPad") ||
                  ...
                  b < 534) ||
                (f.operamini &&
                  "[object OperaMini]" === {}.toString.call(f.operamini)) ||
                (_ && x < 7458) ||
                (-1 < m.indexOf("Android") && b && b < 533) ||
                (w && w < 6) ||
                ("palmGetResource" in S && b && b < 534) ||
                (-1 < m.indexOf("MeeGo") &&
                  -1 < m.indexOf("NokiaBrowser/8.5.0"))
              )),
            scrollTop:
              ("pageXOffset" in S ||
                "scrollTop" in A.documentElement ||
                "scrollTop" in C[0]) &&
              !k &&
              !$,
            dynamicBaseTag:
              ...
              (c = r("<a href='testurl' />").prependTo(C)[0].href),
              (d[0].href = p || location.pathname),
              h && h.remove(),
              0 === c.indexOf(u)),
            cssPointerEvents:
              ((s = A.createElement("x")),
              ...
              "pointerEvents" in s.style &&
                ((s.style.pointerEvents = "auto"),
                (s.style.pointerEvents = "x"),
                a.appendChild(s),
                (o = l && "auto" === l(s, "").pointerEvents),
                a.removeChild(s),
                !!o)),
            boundingRect:
              void 0 !== A.createElement("div").getBoundingClientRect,
            inlineSVG: function () {
              var e = S,
                t = !(
          ...
          C.remove(),
          (n =
            -1 < (i = S.navigator.userAgent).indexOf("Nokia") &&
            (-1 < i.indexOf("Symbian/3") || -1 < i.indexOf("Series60/5")) &&
            -1 < i.indexOf("AppleWebKit") &&
            i.match(/(BrowserNG|NokiaBrowser)\/7\.[0-3]/)),
          (r.mobile.gradeA = function () {
            return (
              ((r.support.mediaquery && r.support.cssPseudoElement) ||
                (r.mobile.browser.oldIE && 8 <= r.mobile.browser.oldIE)) &&
              (r.support.boundingRect ||
                null !== r.fn.jquery.match(/1\.[0-7+]\.[0-9+]?/))
            );
          }),
          (r.mobile.ajaxBlacklist = (S.blackberry && !S.WebKitPoint) || $ || n),
          n &&
            r(function () {
      ...
      (r = (o = e).mobile.window),
      (i = function () {}),
      (o.event.special.beforenavigate = {
        setup: function () {
          r.on("navigate", i);
        },
        teardown: function () {
      ...
      (o.event.special.navigate = n =
        {
          ...
          popstate: function (e) {
            ...
            (n.originalEvent = e),
              ...
              n.isDefaultPrevented() ||
                (e.historyState && o.extend(i, e.historyState),
                (t.originalEvent = e),
                setTimeout(function () {
                  r.trigger(t, {
                    state: i,
          ...
          setup: function () {
            n.bound ||
              ((n.bound = !0),
              n.isPushStateEnabled()
                ? ((n.originalEventName = "popstate"),
                  r.bind("popstate.navigate", n.popstate))
                : n.isHashChangeEnabled() &&
                  ((n.originalEventName = "hashchange"),
                  r.bind("hashchange.navigate", n.hashchange)));
          },
        }),
      (function (e) {
        ...
        var t,
          ...
          o = function () {
            (n = new Date().getTime()),
              250 <= (i = n - r)
                ? ((r = n), e(this).trigger("throttledresize"))
                : (t && clearTimeout(t), (t = setTimeout(o, 250 - i)));
          },
          r = 0;
      })(e),
      (function (t, n) {
        ...
        t.support.orientation &&
          ((a = n.innerWidth || c.width()),
          50,
          (r = (l = n.innerHeight || c.height()) < a && 50 < a - l),
          (s = d[n.orientation]),
          ((r && s) || (!r && !s)) &&
            (d = {
              "-90": !0,
          ...
          (t.event.special.orientationchange.orientation = i =
            function () {
      ...
      (function (h, e, t, p) {
            ...
            ((n && n[e]) ||
              ...
              ((i = (function (e, t) {
                ...
                if (
                  ...
                  (n = e.originalEvent),
                  (i = h.event.props),
                  -1 < d.search(/^(mouse|click)/) && (i = k),
                  n)
                )
                  for (l = i.length; l; ) e[(r = i[--l])] = n[r];
                if (
                  (-1 < d.search(/mouse(down|up)|click/) &&
                    !e.which &&
                    (e.which = 1),
                  -1 !== d.search(/^touch/) &&
                    ((d = (o = f(n)).touches),
                    (s = o.changedTouches),
                    (a = d && d.length ? d[0] : s && s.length ? s[0] : p)))
                )
                  for (c = 0, u = E.length; c < u; c++) e[(r = E[c])] = a[r];
                return e;
              })(t, e)),
              h(t.target).trigger(i)),
            i
          );
        }
        function u(e) {
        ...
        function m(e) {
          D || (B || c("vmousecancel", e, r(e.target)), (B = !0), a());
        }
        function g(e) {
          if (!D) {
            var t = f(e).touches[0],
              ...
              o = r(e.target);
            (B = B || Math.abs(t.pageX - S) > i || Math.abs(t.pageY - A) > i) &&
              !n &&
              c("vmousecancel", e, o),
              c("vmousemove", e, o),
              a();
            ...
            function (e) {
              ...
              if (s)
                for (
                  t = e.clientX,
                    n = e.clientY,
                    w = h.vmouse.clickDistanceThreshold,
                    i = a;
                  i;
      ...
      (function (c, r, s) {
        function u(e, t, n, i) {
          var o = n.type;
          (n.type = t),
            i ? c.event.trigger(n, s, e) : c.event.dispatch.call(e, n),
            (n.type = o);
        }
        var d = c(A),
          ...
          (c.event.special.tap = {
            ...
            setup: function () {
              ...
              a.bind("vmousedown", function (e) {
                ...
                function n() {
                  t(),
                    a.unbind("vclick", i).unbind("vmouseup", t),
                    d.unbind("vmousecancel", n);
                }
                function i(e) {
                  n(),
                    l || r !== e.target
                ...
                var o,
                  r = e.target;
                a.bind("vmouseup", t).bind("vclick", i),
                  d.bind("vmousecancel", n),
                  (o = setTimeout(function () {
                    c.event.special.tap.emitTapOnTaphold || (l = !0),
                      u(
                        s,
                        "taphold",
                        c.Event("taphold", {
          ...
          (c.event.special.swipe = {
            ...
            getLocation: function (e) {
              var t = r.pageXOffset,
                ...
                o = e.clientY;
              return (
                (0 === e.pageY && Math.floor(o) > Math.floor(e.pageY)) ||
                (0 === e.pageX && Math.floor(i) > Math.floor(e.pageX))
                  ? ((i -= t), (o -= n))
                  : (o < e.pageY - n || i < e.pageX - t) &&
                    ((i = e.pageX - t), (o = e.pageY - n)),
                {
                  x: i,
                  y: o,
                }
            ...
            handleSwipe: function (e, t, n, i) {
              if (
                t.time - e.time < c.event.special.swipe.durationThreshold &&
                Math.abs(e.coords[0] - t.coords[0]) >
                  c.event.special.swipe.horizontalDistanceThreshold &&
                Math.abs(e.coords[1] - t.coords[1]) <
            ...
            setup: function () {
              var e,
                ...
                t = c(r),
                s = {};
              (e = c.data(this, "mobile-events")) ||
                ((e = {
                  length: 0,
                }),
                c.data(this, "mobile-events", e)),
                e.length++,
                ((e.swipe = s).start = function (e) {
                  if (!c.event.special.swipe.eventInProgress) {
                    c.event.special.swipe.eventInProgress = !0;
                    var t,
                      n = c.event.special.swipe.start(e),
                      i = e.target,
                      o = !1;
                    (s.move = function (e) {
                      n &&
                        !e.isDefaultPrevented() &&
                        ((t = c.event.special.swipe.stop(e)),
                        o ||
                          ((o = c.event.special.swipe.handleSwipe(
                            n,
                            t,
                            r,
                            i
                        ...
                        Math.abs(n.coords[0] - t.coords[0]) >
            ...
            teardown: function () {
              ...
              (e = c.data(this, "mobile-events")) &&
                ...
                delete e.swipe,
                e.length--,
                0 === e.length && c.removeData(this, "mobile-events")),
                t &&
                  (t.start && c(this).off(n, t.start),
                  t.move && d.off(h, t.move),
                  t.stop && d.off(l, t.stop));
            },
          }),
          c.each(
            {
  ...
  (function (e) {
    ...
    (y.cleanData =
      ...
      (y.widget = function (e, n, t) {
        ...
        return (
          t || ((t = n), (n = y.Widget)),
          y.isArray(t) && (t = y.extend.apply(null, [{}].concat(t))),
          (y.expr[":"][l.toLowerCase()] = function (e) {
            return !!y.data(e, l);
          }),
          (y[a] = y[a] || {}),
          (i = y[a][e]),
          ...
          ((r = new n()).options = y.widget.extend({}, r.options)),
          ...
          i
            ? (y.each(i._childConstructors, function (e, t) {
                var n = t.prototype;
          ...
          for (t in i[o])
            (n = i[o][t]),
              i[o].hasOwnProperty(t) &&
                void 0 !== n &&
                (e[t] = y.isPlainObject(n)
                  ? y.isPlainObject(e[t])
                    ? y.widget.extend({}, e[t], n)
                    : y.widget.extend({}, n)
                  : n);
        return e;
      }),
      ...
      (y.Widget.prototype = {
        ...
        _createWidget: function (e, t) {
          (t = y(t || this.defaultElement || this)[0]),
            (this.element = y(t)),
            (this.uuid = n++),
            ...
            t !== this &&
              (y.data(t, this.widgetFullName, this),
              this._on(!0, this.element, {
                remove: function (e) {
                  e.target === t && this.destroy();
                },
              }),
              (this.document = y(t.style ? t.ownerDocument : t.document || t)),
              (this.window = y(
        ...
        destroy: function () {
          var n = this;
          this._destroy(),
            y.each(this.classesElementLookup, function (e, t) {
              n._removeClass(t, e);
            }),
            this.element
        ...
        option: function (e, t) {
          ...
          if ("string" == typeof e)
            if (((r = {}), (e = (n = e.split(".")).shift()), n.length)) {
              for (
                i = r[e] = y.widget.extend({}, this.options[e]), o = 0;
                n.length - 1 > o;
                o++
              )
                (i[n[o]] = i[n[o]] || {}), (i = i[n[o]]);
        ...
        _classes: function (o) {
          function e(e, t) {
            ...
            for (i = 0; e.length > i; i++)
              (n = s.classesElementLookup[e[i]] || y()),
                (n = o.add
                  ? y(y.unique(n.get().concat(o.element.get())))
                  : y(n.not(o.element).get())),
        ...
        _untrackClassesElement: function (n) {
          ...
          y.each(i.classesElementLookup, function (e, t) {
            -1 !== y.inArray(n.target, t) &&
              (i.classesElementLookup[e] = y(t.not(n.target).get()));
          });
        },
        ...
        _on: function (s, a, e) {
          ...
          "boolean" != typeof s && ((e = a), (a = s), (s = !1)),
            ...
            y.each(e, function (e, t) {
              ...
              "string" != typeof t &&
                (n.guid = t.guid = t.guid || n.guid || y.guid++);
              var i = e.match(/^([\w:-]*)\s*(.*)$/),
        ...
        _off: function (e, t) {
          (t =
            ...
            this.eventNamespace),
            e.off(t).off(t),
            (this.bindings = y(this.bindings.not(e).get())),
            (this.focusable = y(this.focusable.not(e).get())),
            (this.hoverable = y(this.hoverable.not(e).get()));
        },
        _delay: function (e, t) {
          var n = this;
      ...
      y.extend(y.expr[":"], {
        data: y.expr.createPseudo
          ? y.expr.createPseudo(function (t) {
              return function (e) {
                return !!y.data(e, t);
              };
            })
    ...
    y(document).on("mouseup", function () {
        ...
        _mouseInit: function () {
          ...
          this.element
            ...
            .on("click." + this.widgetName, function (e) {
              return !0 ===
                y.data(e.target, t.widgetName + ".preventClickEvent")
                ? (y.removeData(e.target, t.widgetName + ".preventClickEvent"),
          ...
          if (!r) {
            ...
            var t = this,
              ...
              i =
                ...
                ) && y(e.target).closest(this.options.cancel).length;
            return (
              n &&
                !i &&
          ...
          this.document
            ...
            this._mouseStarted &&
              ...
              e.target === this._mouseDownEvent.target &&
                y.data(e.target, this.widgetName + ".preventClickEvent", !0),
              this._mouseStop(e)),
      ...
      y.widget("ui.draggable", y.ui.mouse, {
        ...
        _mouseCapture: function (e) {
          ...
          return (
            !(
              this.helper ||
              t.disabled ||
              0 < y(e.target).closest(".ui-resizable-handle").length
            ) &&
          ...
          return (
            ...
            !1 === this._trigger("start", e)
              ...
              : (this._cacheHelperProportions(),
                y.ui.ddmanager &&
                  !t.dropBehaviour &&
                  y.ui.ddmanager.prepareOffsets(this, e),
                this._mouseDrag(e, !0),
                y.ui.ddmanager && y.ui.ddmanager.dragStart(this, e),
                !0)
          );
        },
        ...
        _mouseDrag: function (e, t) {
          if (
            ...
            if (!1 === this._trigger("drag", e, n))
              return this._mouseUp(new y.Event("mouseup", e)), !1;
            this.position = n.position;
          }
          return (
            (this.helper[0].style.left = this.position.left + "px"),
            (this.helper[0].style.top = this.position.top + "px"),
            y.ui.ddmanager && y.ui.ddmanager.drag(this, e),
            !1
          );
        },
        ...
        _mouseUp: function (e) {
          return (
            this._unblockFrames(),
            y.ui.ddmanager && y.ui.ddmanager.dragStop(this, e),
            this.handleElement.is(e.target) && this.element.trigger("focus"),
            y.ui.mouse.prototype._mouseUp.call(this, e)
          );
        },
        cancel: function () {
          return (
        ...
        _getHandle: function (e) {
          return (
            !this.options.handle ||
            !!y(e.target).closest(this.element.find(this.options.handle)).length
          );
        },
        ...
        _createHelper: function (e) {
          var t = this.options,
            ...
            i = n
              ? y(t.helper.apply(this.element[0], [e]))
              : "clone" === t.helper
        ...
        _trigger: function (e, t, n) {
          return (
            (n = n || this._uiHash()),
            y.ui.plugin.call(this, e, [t, n, this], !0),
            /^(drag|start|stop)/.test(e) &&
              ((this.positionAbs = this._convertPositionTo("absolute")),
              (n.offset = this.positionAbs)),
            y.Widget.prototype._trigger.call(this, e, t, n)
          );
        },
        plugins: {},
        _uiHash: function () {
                ...
                y.each(o.sortables, function () {
                  return (
                    ...
                    this !== t &&
                      ...
                      y.contains(t.element[0], this.element[0]) &&
                      (e = !1),
                    e
                  );
                })),
              e
                ? (t.isOver ||
                    ...
                    (t.offset.parent.left -=
                      o.offset.parent.left - t.offset.parent.left),
                    (t.offset.parent.top -=
                      o.offset.parent.top - t.offset.parent.top),
              ...
              (i.axis && "y" === i.axis) ||
                ...
                i.scrollSensitivity
                  ...
                  : e.pageX - n.overflowOffset.left < i.scrollSensitivity &&
                    (r.scrollLeft = o = r.scrollLeft - i.scrollSpeed)))
            : ((i.axis && "x" === i.axis) ||
                (e.pageY - y(s).scrollTop() < i.scrollSensitivity
                  ? (o = y(s).scrollTop(y(s).scrollTop() - i.scrollSpeed))
                  : y(window).height() - (e.pageY - y(s).scrollTop()) <
                      i.scrollSensitivity &&
                    (o = y(s).scrollTop(y(s).scrollTop() + i.scrollSpeed))),
              (i.axis && "y" === i.axis) ||
                (e.pageX - y(s).scrollLeft() < i.scrollSensitivity
                  ? (o = y(s).scrollLeft(y(s).scrollLeft() - i.scrollSpeed))
                  : y(window).width() - (e.pageX - y(s).scrollLeft()) <
                      i.scrollSensitivity &&
                    (o = y(s).scrollLeft(y(s).scrollLeft() + i.scrollSpeed)))),
            !1 !== o &&
              y.ui.ddmanager &&
              !i.dropBehaviour &&
              y.ui.ddmanager.prepareOffsets(n, e);
        },
      }),
      ...
      y.widget("ui.droppable", {
        ...
        _addToManager: function (e) {
          (y.ui.ddmanager.droppables[e] = y.ui.ddmanager.droppables[e] || []),
            y.ui.ddmanager.droppables[e].push(this);
        },
        _splice: function (e) {
        ...
        switch (n) {
          ...
          case "intersect":
            return (
              ...
              u > s - e.helperProportions.width / 2 &&
              r + e.helperProportions.height / 2 > c &&
              d > a - e.helperProportions.height / 2
            );
          case "pointer":
            return (
    ...
    !(y.ui.ddmanager = {
      ...
      prepareOffsets: function (e, t) {
        var n,
          i,
          o = y.ui.ddmanager.droppables[e.options.scope] || [],
          r = t ? t.type : null,
        ...
        e: for (n = 0; o.length > n; n++)
          if (
            ...
            (o[n].visible = "none" !== o[n].element.css("display")),
              o[n].visible &&
                ("mousedown" === r && o[n]._activate.call(o[n], t),
      ...
      drop: function (e, t) {
        ...
        return (
          y.each(
            (y.ui.ddmanager.droppables[e.options.scope] || []).slice(),
            function () {
              this.options &&
                (!this.options.disabled &&
                  this.visible &&
          ...
          y.each(y.ui.ddmanager.droppables[r.options.scope] || [], function () {
            if (!this.options.disabled && !this.greedyChild && this.visible) {
              var e,
                t,
                n,
                i = l(r, this, this.options.tolerance, s),
                o =
                  !i && this.isover
                    ? "isout"
                    : i && !this.isover
              ...
              o &&
                (this.options.greedy &&
                  ...
                  (n = this.element
                    ...
                    ((e = y(n[0]).droppable("instance")).greedyChild =
                      "isover" === o)),
                e &&
                  "isover" === o &&
      ...
      return m(this).each(function () {
        ...
        if (0 == i.length) {
          (i = m("<div />").addClass(c)),
            (a = m("<div />").addClass(u)),
            (n = m("<div />").addClass(d)),
            m(this).children().appendTo(n),
            n.appendTo(a),
            a.appendTo(i),
            m(this).append(i),
            (e = m("<div />")).addClass(h),
            e.css("width", f),
            e.css("background-color", s.scrollbarTrackColor),
            ...
            e.click(function (e) {
              ...
              i < o
                ...
                : o + r < i && a.scrollTop(a.scrollTop() + s),
                e.preventDefault(),
                e.stopPropagation();
            }),
            (l = m("<div />")).addClass(p),
            l.css("width", f),
            l.css("background-color", s.scrollbarColor),
        ...
        e.css("right", 0),
          n.css("width", o),
          a.css("height", m(this).height()),
          n.height() > m(this).height()
            ? ((t = (m(this).height() / n.height()) * m(this).height()),
              e.show())
            : ((t = 0), e.hide()),
          l.css("height", t),
          a.scroll();
    ...
    f.fn.qrcode = function (c) {
      ...
      (t.prototype = {
        ...
        (u.prototype = {
          ...
          make: function () {
            if (this.typeNumber < 1) {
              ...
              for (e = 1; e < 40; e++) {
                for (
                  var t = h.getRSBlocks(e, this.errorCorrectLevel),
                    n = new s(),
                    i = 0,
                    o = 0;
                  o < t.length;
                ...
                for (o = 0; o < this.dataList.length; o++)
                  (t = this.dataList[o]),
                    n.put(t.mode, 4),
                    n.put(t.getLength(), p.getLengthInBits(t.mode, e)),
                    t.write(n);
          ...
          createMovieClip: function (e, t, n) {
            for (
              e = e.createEmptyMovieClip(t, n), this.make(), t = 0;
          ...
          setupPositionAdjustPattern: function () {
            for (
              var e = p.getPatternPosition(this.typeNumber), t = 0;
              t < e.length;
              t++
            )
          ...
          setupTypeNumber: function (e) {
            for (
              var t = p.getBCHTypeNumber(this.typeNumber), n = 0;
              n < 18;
              n++
            ) {
              var i = !e && 1 == ((t >> n) & 1);
          ...
          setupTypeInfo: function (e, t) {
            for (
              var n = p.getBCHTypeInfo((this.errorCorrectLevel << 3) | t),
                i = 0;
              i < 15;
              i++
            ) {
              ...
              for (6 == s && s--; ; ) {
                for (var a = 0; a < 2; a++)
                  if (null == this.modules[i][s - a]) {
                    var l = !1;
                    r < e.length && (l = 1 == ((e[r] >>> o) & 1)),
                      p.getMask(t, i, s - a) && (l = !l),
        ...
        (u.createData = function (e, t, n) {
          ...
          for (var i = new s(), o = 0; o < n.length; o++) {
            var r = n[o];
            i.put(r.mode, 4),
              i.put(r.getLength(), p.getLengthInBits(r.mode, e)),
              r.write(i);
          }
          ...
          for (
            i.getLengthInBits() + 4 <= 8 * e && i.put(0, 4);
          ...
          for (
            ...
            (i.put(u.PAD0, 8), !(i.getLengthInBits() >= 8 * e));
      ...
      for (
        var p = {
            ...
            getBCHTypeInfo: function (e) {
              for (
                var t = e << 10;
                0 <= p.getBCHDigit(t) - p.getBCHDigit(p.G15);
            ...
            getBCHTypeNumber: function (e) {
              for (
                var t = e << 12;
                0 <= p.getBCHDigit(t) - p.getBCHDigit(p.G18);
            ...
            getErrorCorrectPolynomial: function (e) {
              for (var t = new d([1], 0), n = 0; n < e; n++)
                t = t.multiply(new d([1, o.gexp(n)], 0));
              return t;
            },
            ...
            getLostPoint: function (e) {
              for (var t = e.getModuleCount(), n = 0, i = 0; i < t; i++)
                for (var o = 0; o < t; o++) {
                  for (var r = 0, s = e.isDark(i, o), a = -1; a <= 1; a++)
                    if (!(i + a < 0 || t <= i + a))
                      for (var l = -1; l <= 1; l++)
                        o + l < 0 ||
                          t <= o + l ||
                          (0 == a && 0 == l) ||
                          (s == e.isDark(i + a, o + l) && r++);
                  5 < r && (n += 3 + r - 5);
                }
              for (i = 0; i < t - 1; i++)
                for (o = 0; o < t - 1; o++)
      ...
      return (
        (d.prototype = {
          ...
          multiply: function (e) {
            for (
              var t = Array(this.getLength() + e.getLength() - 1), n = 0;
              n < this.getLength();
              n++
            )
        ...
        (h.getRSBlocks = function (e, t) {
          ...
          for (var i = n.length / 3, o = [], r = 0; r < i; r++)
            for (
              var s = n[3 * r + 0], a = n[3 * r + 1], l = n[3 * r + 2], c = 0;
              c < s;
              c++
            )
              o.push(new h(a, l));
          ...
          if ("canvas" == c.render) {
            ...
            for (
              var n = t.getContext("2d"),
                i = c.width / e.getModuleCount(),
                o = c.height / e.getModuleCount(),
                r = 0;
              r < e.getModuleCount();
              r++
            )
            ...
            for (
              (e = new u(c.typeNumber, c.correctLevel)).addData(c.text),
                e.make(),
                t = f("<table></table>")
                  ...
                  .css("background-color", c.background),
                n = c.width / e.getModuleCount(),
                i = c.height / e.getModuleCount(),
                o = 0;
              o < e.getModuleCount();
              o++
            )
  ...
  (function () {
    function n(e, t) {
      ...
      return (
        setTimeout(function () {
          (n.className += " notyf--disappear"),
            n.addEventListener(a.animationEnd, function (e) {
              e.target == n && a.container.removeChild(n);
            });
          var e = a.notifications.indexOf(n);
    ...
    (this.Notyf = function () {
      ...
      arguments[0] && "object" == typeof arguments[0]
        ? (this.options = (function (e, t) {
            for (property in t)
              t.hasOwnProperty(property) && (e[property] = t[property]);
            return e;
          })(e, arguments[0]))
        : (this.options = e);
      ...
      (this.Notyf.prototype.alert = function (e) {
        var t = n.call(this, e, this.options.alertIcon);
        (t.className += " notyf--alert"),
          this.container.appendChild(t),
          this.notifications.push(t);
      }),
      (this.Notyf.prototype.confirm = function (e) {
        var t = n.call(this, e, this.options.confirmIcon);
        (t.className += " notyf--confirm"),
          this.container.appendChild(t),
          this.notifications.push(t);
      });
  })(),
  "function" == typeof define && define.amd
    ? define("Notyf", function () {
        return Notyf;
      })
...
!(function (e) {
        ...
        .on(
          ...
          function (e) {
            ...
            t.hasClass("btn") || (t = t.closest(".btn")),
              n.call(t, "toggle"),
              r(e.target).is('input[type="radio"]') ||
                r(e.target).is('input[type="checkbox"]') ||
                e.preventDefault();
          }
        )
        .on(
  ...
  (function (s) {
    ...
    var l = function (e, t) {
      (this.$element = s(e)),
        (this.options = s.extend({}, l.DEFAULTS, t)),
        (this.$trigger = s(
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            ...
            if ((this.$element.trigger(n), !n.isDefaultPrevented())) {
              t &&
                t.length &&
                (a.call(t, "hide"), e || t.data("bs.collapse", null));
      ...
      (i.prototype.toggle = function (e) {
        ...
        if (!t.is(".disabled, :disabled")) {
          ...
          if ((r(), !i)) {
            ...
            if (
              (n.trigger((e = s.Event("show.bs.dropdown", o))),
              e.isDefaultPrevented())
            )
              return;
        ...
        if (
          ...
          if (
            ...
            if ((!i && 27 != e.which) || (i && 27 == e.which))
              return (
                27 == e.which && n.find(l).trigger("focus"), t.trigger("click")
              );
      ...
      r(document).on(
        ...
        function (e) {
          var t = r(this),
            n = t.attr("href"),
            i = r(
              t.attr("data-target") || (n && n.replace(/.*(?=#[^\s]+$)/, ""))
            ),
            o = i.data("bs.modal")
              ? "toggle"
              : r.extend(
  ...
  (function (m) {
    ...
    (g.VERSION = "3.3.5"),
      ...
      (g.prototype.getOptions = function (e) {
        return (
          (e = m.extend({}, this.getDefaults(), this.$element.data(), e))
            .delay &&
      ...
      (g.prototype.enter = function (e) {
        var t =
          e instanceof this.constructor
            ? e
            : m(e.currentTarget).data("bs." + this.type);
        return (
          t ||
          ...
          e instanceof m.Event &&
            (t.inState["focusin" == e.type ? "focus" : "hover"] = !0),
          t.tip().hasClass("in") || "in" == t.hoverState
            ? void (t.hoverState = "in")
      ...
      (g.prototype.leave = function (e) {
        ...
        return (
          t ||
            ...
            m(e.currentTarget).data("bs." + this.type, t)),
          e instanceof m.Event &&
            (t.inState["focusout" == e.type ? "focus" : "hover"] = !1),
          t.isInStateTrue()
            ? void 0
            : (clearTimeout(t.timeout),
              (t.hoverState = "out"),
      ...
      (g.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (a) {
            ...
            (r =
              "bottom" == r && l.bottom + u > h.bottom
                ? "top"
                : "top" == r && l.top - u < h.top
                ? "bottom"
                : "right" == r && l.right + c > h.width
                ? "left"
                : "left" == r && l.left - c < h.left
                ? "right"
                : r),
        ...
        e &&
          ...
          e
            ? ((t.inState.click = !t.inState.click),
              t.isInStateTrue() ? t.enter(t) : t.leave(t))
            : t.tip().hasClass("in")
            ? t.leave(t)
            : t.enter(t);
      }),
    ...
    (m.fn.tooltip = function (i) {
      return this.each(function () {
        ...
        (t || !/destroy|hide/.test(i)) &&
          (t || e.data("bs.tooltip", (t = new g(this, n))),
          "string" == typeof i && t[i]());
      });
    }),
    ...
    (o.fn.popover = function (i) {
      return this.each(function () {
        var e = o(this),
          ...
          n = "object" == typeof i && i;
        (t || !/destroy|hide/.test(i)) &&
          (t || e.data("bs.popover", (t = new r(this, n))),
          "string" == typeof i && t[i]());
      });
    }),
          ...
          this.$body
            ...
            .map(function () {
              var e = r(this),
                ...
                n = /^#./.test(t) && r(t);
              return (
                (n && n.length && n.is(":visible") && [[n[i]().top + o, t]]) ||
                null
              );
            })
            .sort(function (e, t) {
      ...
      (s.prototype.activate = function (e, t, n) {
        ...
        var o = t.find("> .active"),
          r =
            ...
            ((o.length && o.hasClass("fade")) || !!t.find("> .fade").length);
        o.length && r
          ? o
    ...
    function n(i) {
      return this.each(function () {
        var e = l(this),
          t = e.data("bs.affix"),
          n = "object" == typeof i && i;
        t || e.data("bs.affix", (t = new c(this, n))),
          "string" == typeof i && t[i]();
      });
    }
    var c = function (e, t) {
...
var CanvasImage = function (e) {
  (this.canvas = document.createElement("canvas")),
    ...
    (this.height = this.canvas.height = e.height / 2);
  var t = -this.height / 2;
  ...
  (ColorThief.prototype.getPalette = function (e, t, n) {
    ...
    for (
      ...
      (o = l[(i = 4 * d) + 0]),
        ...
        (s = l[i + 2]),
        125 <= l[i + 3] &&
          ((250 < o && 250 < r && 250 < s) || u.push([o, r, s]));
...
var MMCQ = (function () {
  ...
  function A(e, c) {
    if (c.count()) {
      ...
      if (o == t)
        for (u = c.r1; u <= c.r2; u++) {
          for (a = 0, r = c.g1; r <= c.g2; r++)
            for (s = c.b1; s <= c.b2; s++) a += e[k(u, r, s)] || 0;
          (d += a), (h[u] = d);
        }
      else if (o == n)
        for (u = c.g1; u <= c.g2; u++) {
          for (a = 0, r = c.r1; r <= c.r2; r++)
            for (s = c.b1; s <= c.b2; s++) a += e[k(r, u, s)] || 0;
          (d += a), (h[u] = d);
        }
      else
        for (u = c.b1; u <= c.b2; u++) {
          for (a = 0, r = c.r1; r <= c.r2; r++)
            for (s = c.g1; s <= c.g2; s++) a += e[k(r, s, u)] || 0;
          (d += a), (h[u] = d);
        }
      return (
        ...
        if (h[u] > d / 2) {
          for (
            i = c.copy(),
              ...
              r =
                (t = u - c[s]) <= (n = c[a] - u)
                  ? Math.min(c[a] - 1, ~~(u + n / 2))
                  : Math.max(c[s], ~~(u - 1 - t / 2));
            !h[r];
  ...
  return (
    ...
    (S.prototype = {
      ...
      nearest: function (e) {
        for (var t, n, i, o = this.vboxes, r = 0; r < o.size(); r++)
          ((n = Math.sqrt(
...
function jQVue(options) {
  ...
  (this.$default_renderer = {
    ...
    input: function (e, t) {
      $(
        "input[v-model][type=text],input[v-model][type=search],input[v-model]:not([type])"
      ).each(function (e, t) {
  ...
  (this.$rerender = function (e, t) {
    for (var n in this.$default_renderer)
      try {
  ...
  for (var method in ($(document).on(
    "click",
    options.el + " [\\@click]:not([disabled])",
    function (e) {
  ...
  options.methods))
    options[method] || (this[method] = options.methods[method]);
  ...
  options.data))
    this.$set(this, key, options.data[key]);
  for (var method in this.$beforeMounted)
    try {
      this.$beforeMounted[method]();
    } catch (e) {
      console.log(e);
    }
  $(function () {
...
!(function (e) {
        ...
        function (e, t, n) {
          ...
          function l(e, t, n, i, o, r) {
            if (!(isNaN(r) || r < 1)) {
              ...
              var s = a(e, t, n, i, o);
              (s = c(s, t, n, i, o, r)),
                e.getContext("2d").putImageData(s, t, n);
            }
          }
          function c(e, t, n, i, o, r) {
            ...
            for (a = 0; a < o; a++) {
              for (
                ...
                (j.r = T), (j.g = k), (j.b = $), (j.a = N), (j = j.next);
              for (l = 1; l < D; l++)
                (c = d + ((L < l ? L : l) << 2)),
                  (p += (j.r = T = A[c]) * (S = D - l)),
                  (f += (j.g = k = A[c + 1]) * S),
  ...
  (function (p) {
    p.fn.circleMagic = function (e) {
      ...
      function u() {
        (r = document.querySelector(c.elem)),
          (i = p(r).width()),
          (o = p(r).height()),
          (s.width = i),
          (s.height = o);
      ...
      function h() {
        ...
        function t() {
          (e.pos.x = Math.random() * i),
            (e.pos.y = o + 100 * Math.random()),
            (e.alpha = 0.1 + Math.random() * c.clearOffset),
        ...
        (e.pos = {}),
          ...
          (this.draw = function () {
            e.alpha <= 0 && t(),
              ...
              (e.alpha -= 5e-4),
              a.beginPath(),
              a.arc(e.pos.x, e.pos.y, e.scale * c.radius, 0, 2 * Math.PI, !1),
              (a.fillStyle = e.color),
              a.fill(),
              a.closePath();
          });
      ...
      !(function () {
        (r = document.querySelector(c.elem)),
          ...
          (e.id = "canvas"),
          p(r).append(e),
          ((s = document.getElementById("canvas")).width = i),
          (s.height = o),
          (a = s.getContext("2d"));
        var e;
  ...
  (function (e, t) {
    ...
    (A.prototype.eos = function () {
      ...
      (r.prototype.lookup = function (e) {
        ...
        if (n.hasOwnProperty(e)) t = n[e];
          ...
          for (var i, o, r = this, s = !1; r; ) {
            if (0 < e.indexOf("."))
              for (
                t = r.view, i = e.split("."), o = 0;
                null != t && o < i.length;

              )
                o === i.length - 1 && (s = a(t, i[o])), (t = t[i[o++]]);
            ...
            (i = n[e] =
              (function (e, t) {
                ...
                function d(e) {
                  ...
                  (n = new RegExp(C(e[0]) + "\\s*")),
                    (i = new RegExp("\\s*" + C(e[1]))),
                    (o = new RegExp("\\s*" + C("}" + e[1])));
                }
                d(t || _.tags);
                for (var h, p, f, m, g, v, b = new A(e); !b.eos(); ) {
                  if (((h = b.pos), (f = b.scanUntil(n))))
                    for (var y = 0, w = f.length; y < w; ++y)
                      E((m = f.charAt(y))) ? a.push(s.length) : (c = !0),
                        s.push(["text", m, h, h + 1]),
                        (h += 1),
                        "\n" === m && u();
                  if (!b.scan(n)) break;
                  if (
                    ...
                    b.scan(T),
                    "=" === p
                      ? ((f = b.scanUntil($)), b.scan($), b.scanUntil(i))
                      : "{" === p
                      ? ((f = b.scanUntil(o)),
                        b.scan(N),
                        b.scanUntil(i),
                  ...
                  if (
                    ((g = [p, f, h, b.pos]), s.push(g), "#" === p || "^" === p)
                  )
                    r.push(g);
                  else if ("/" === p) {
                    if (!(v = r.pop()))
                      throw new Error('Unopened section "' + f + '" at ' + h);
                    if (v[1] !== f)
                      throw new Error(
                        'Unclosed section "' + v[1] + '" at ' + h
                      );
                  } else
                    "name" === p || "{" === p || "&" === p
                      ? (c = !0)
                ...
                if ((v = r.pop()))
                  throw new Error(
                    'Unclosed section "' + v[1] + '" at ' + b.pos
                  );
                return (function (e) {
                  for (
                    var t, n = [], i = n, o = [], r = 0, s = e.length;
                    r < s;
                    ++r
                  )
                    switch ((t = e[r])[0]) {
      ...
      (e.prototype.renderTokens = function (e, t, n, i) {
        for (var o, r, s, a = "", l = 0, c = e.length; l < c; ++l)
          (s = void 0),
            "#" === (r = (o = e[l])[0])
              ? (s = this.renderSection(o, t, n, i))
              : "^" === r
              ? (s = this.renderInverted(o, t, n, i))
              : ">" === r
        ...
        if (s) {
          if (x(s))
            for (var a = 0, l = s.length; a < l; ++a)
              r += this.renderTokens(e[4], t.push(s[a]), n, i);
          else if (
            "object" == typeof s ||
            "string" == typeof s ||
            "number" == typeof s
          )
            r += this.renderTokens(e[4], t.push(s), n, i);
          else if (c(s)) {
            if ("string" != typeof i)
              throw new Error(
            ...
            null !=
              (s = s.call(t.view, i.slice(e[3], e[5]), function (e) {
  ...
  (function (v) {
    v.fn.pandaSlider = function (e, t, i) {
      var g = {
        init: function (n) {
          if (n.data("pandaSlider_init")) return !1;
          n.data("allPages", n.children(".page")), n.children(".page").remove();
          for (
            var e = v(n).attr("showbox-wrap-class") || "",
              t = v('<div class="showBox ' + e + '">'),
              i = g.makeClassArray(n),
              o = 0;
            o < i.length;
            o++
          )
            t.append(v('<div class="' + i[o].class + '">'));
          n.append(t),
            n.data("currentIndex", 0),
            g.fill_pages_with_currentIndex(n);
          var r = v(n).attr("prev-text"),
            s = v(n).attr("next-text"),
            a = v(n).attr("navigator-wrap-class") || "";
          if ((void 0 !== r && !1 !== r) || (void 0 !== s && !1 !== s)) {
            n.append('<div class="navigator ' + a + '">');
            var l = n.children(".navigator");
            void 0 !== r &&
              !1 !== r &&
              (l.append('<div class="prev">' + r + "</div>"),
              l.children(".prev").on("click", function (e) {
                g.prev(n);
              })),
              void 0 !== s &&
                !1 !== s &&
                (l.append('<div class="next">' + s + "</div>"),
                l.children(".next").on("click", function (e) {
                  g.next(n);
                }));
          }
          var c = v(n).attr("show-anchor"),
            u = v(n).attr("anchor-wrap-class") || "";
          void 0 !== c &&
            !1 !== c &&
            n.append('<div class="anchor ' + u + '">');
          for (o = 0; o < n.data("allPages").length; o++) {
            var d = v("<div>");
            v(n.data("allPages")[o]).attr("anchor-background-image") &&
              d.css(
                "background-image",
                "url(" +
                  v(n.data("allPages")[o]).attr("anchor-background-image") +
              ...
              v(n.data("allPages")[o]).attr("anchor-background-color") &&
                d.css(
                  "background-color",
                  v(n.data("allPages")[o]).attr("anchor-background-color")
                ),
              n.children(".anchor").append(d);
          }
          var h = v(n).attr("allow-anchor-click");
          void 0 !== h &&
            !1 !== h &&
            n
              .children(".anchor")
            ...
            g.parse_anchor_with_currentIndex(n);
          var p = v(n).attr("allow-keyboard");
          void 0 !== p &&
            !1 !== p &&
          ...
          var f = v(n).attr("allow-swipe");
          void 0 !== f &&
            !1 !== f &&
            (n.children(".showBox").on("swiperight", function (e) {
              g.prev(n);
              var t = v(n).attr("hover-disable-interval");
              void 0 !== t &&
                !1 !== t &&
                (g.interval(n, !1),
                window.setTimeout(function () {
            ...
            g.interval(n, !0);
          var m = v(n).attr("hover-disable-interval");
          void 0 !== m &&
            !1 !== m &&
            n.hover(
              function () {
            ...
            n.attr("init", ""),
            n.data("pandaSlider_init", !0),
            g.callback_onInit(n);
        },
        fill_pages_with_currentIndex: function (o) {
          function e(e) {
            var t = o.data("currentIndex"),
              n = o.data("allPages").length;
            if (n - 1 < e + t) i = 0 == (i = (e + t + 1) % n) ? n - 1 : i - 1;
            else if (e + t < 0) var i = ((e + t + 1) % n) + n - 1;
            else i = e + t;
            return i;
          }
          for (var t = g.makeClassArray(o), n = 0; n < t.length; n++) {
            var i = o.children(".showBox").children("." + t[n].class);
            i.children().get(0)
              ? i
                  .children()
                  .get(0)
                  .isEqualNode(o.data("allPages")[e(t[n].offset)]) ||
                (i.find("*").removeData(),
                i.find("*").remove(),
                i.children().remove(),
                i
                  .html("")
                  .append(v(o.data("allPages")[e(t[n].offset)]).clone(!0)))
              : i.append(v(o.data("allPages")[e(t[n].offset)]).clone(!0));
          }
        },
        interval: function (e, t) {
          if (t) {
            var n = v(e).attr("interval-time");
            if (void 0 !== n && !1 !== n) {
              var i = parseInt(n);
              i &&
                e.data(
        ...
        parse_anchor_with_currentIndex: function (l) {
          var e = v(l).attr("show-anchor");
          if (void 0 === e || !1 === e) return !1;
          var t = l.find(".anchor").children(),
            n = l.data("currentIndex"),
            c = v(t.get(n));
          t.removeClass("active"),
            c.addClass("active"),
            window.setTimeout(function () {
              var e = l.children(".anchor").outerWidth(),
                t = c.outerWidth(),
                n = c.position().left,
                i = l.children(".anchor").scrollLeft();
              (half_Left = (e - t) / 2),
                (scrollLeft = n + i - half_Left),
                (scrollLeft =
                  scrollLeft > l.children(".anchor").get(0).scrollWidth - e
                    ? l.children(".anchor").get(0).scrollWidth - e
                    : scrollLeft),
                (scrollLeft = scrollLeft < 0 ? 0 : scrollLeft);
              var o = l.children(".anchor").outerHeight(),
                r = c.outerHeight(),
                s = c.position().top,
                a = l.children(".anchor").scrollTop();
              (half_Top = (o - r) / 2),
                (scrollTop = s + a - half_Top),
                (scrollTop =
                  scrollTop > l.children(".anchor").get(0).scrollHeight - o
                    ? l.children(".anchor").get(0).scrollHeight - o
                    : scrollTop),
                (scrollTop = scrollTop < 0 ? 0 : scrollTop),
                l.children(".anchor").animate(
                  {
                    scrollTop: scrollTop,
        ...
        next: function (e) {
          ...
          for (var t = g.makeClassArray(e), n = {}, i = 0; i < t.length; i++)
            n[t[i].class] = e.children(".showBox").children("." + t[i].class);
          for (i = 0; i < t.length; i++) {
            var o = n[t[i].class];
            0 == i
              ? o.removeClass(t[i].class).addClass(t[t.length - 1].class)
              : o.removeClass(t[i].class).addClass(t[i - 1].class);
          }
          var r = e.data("currentIndex") + 1;
          (r = r > e.data("allPages").length - 1 ? 0 : r),
            e.data("currentIndex", r),
            g.fill_pages_with_currentIndex(e),
            g.parse_anchor_with_currentIndex(e),
            g.callback_onChange(e);
        },
        prev: function (e) {
          if (!e.data("pandaSlider_init")) return !1;
          for (var t = g.makeClassArray(e), n = {}, i = 0; i < t.length; i++)
          ...
          for (i = 0; i < t.length; i++) {
            var o = n[t[i].class];
            i == t.length - 1
              ? o.removeClass(t[i].class).addClass(t[0].class)
              : o.removeClass(t[i].class).addClass(t[i + 1].class);
          }
          var r = e.data("currentIndex") - 1;
          (r = r < 0 ? e.data("allPages").length - 1 : r),
            e.data("currentIndex", r),
            g.fill_pages_with_currentIndex(e),
            g.parse_anchor_with_currentIndex(e),
            g.callback_onChange(e);
        ...
        jumpTo: function (e, t) {
          if (!e.data("pandaSlider_init")) return !1;
          var n = e.data("allPages").length,
            i = e.data("currentIndex");
          if (n - 1 < t || t < 0) return console.log("Index不在范围内"), !1;
          if (i + 1 == t || (i == n - 1 && 0 == t)) return g.next(e), !1;
          if (i - 1 == t || (0 == i && t == n - 1)) return g.prev(e), !1;
          if (i != t) {
            var o = i < t ? "next" : "prev";
            g[o](e),
              setTimeout(function () {
                g[o](e),
                  e.data("currentIndex", t),
                  g.fill_pages_with_currentIndex(e),
                  g.parse_anchor_with_currentIndex(e),
                  g.callback_onChange(e);
              }, 150);
        ...
        makeClassArray: function (e) {
          for (
            var t = parseInt(v(e).attr("view")), n = [], i = (t = t || 0) - 1;
            0 <= i;
            i--
          )
            n.push({
        ...
        callback_onChange: function (e) {
          var t = e.data("currentIndex"),
            n = e.data("allPages")[t];
          i && i.onChange && i.onChange(t, n);
        },
        callback_onInit: function (e) {
          var t = e.data("currentIndex"),
            n = e.data("allPages")[t];
          i && i.onInit && i.onInit(t, n);
        },
      };
      switch (e) {
        case "next":
      ...
      var s = {
        init: function (t) {
          ...
          n.addClass("anchor"),
            ...
            a(e).prepend(n),
            a(e).data("subMenu_isActive", !1),
            a(e).data("pandaTab_init", !0);
          var i = a(t).attr("sub-trigger");
          "hover" == i
            ? s.addHoverEvent(t)
            : ("click" == i || s.addHoverEvent(t), s.addClickEvent(t)),
            s.autoScrolling(t);
          var o = a(t).attr("native-scrolling");
          void 0 !== o && !1 !== o && s.useNativeScrolling(t),
            a(window).resize(function (e) {
              s.hideAllSubMenu(t),
                a(t).children("ul").children("li").removeClass("hover"),
                s.parseActivePosition(a(t).children("ul")),
                void 0 !== o && !1 !== o && s.useNativeScrolling(t);
            }),
            s.scrollToActivePosition(t),
            s.parseActivePosition(a(t).children("ul"));
        },
        parseActivePosition: function (e) {
          ...
          if (
            (n.removeClass("has_sub_menu"), 0 < a(e).children(".hover").length)
          ) {
            var i = a(e).parent().attr("ignore-class");
            0 <
              (r = a(e).children(".hover").not(i).first()).children(t).length &&
              n.addClass("has_sub_menu");
          }
          if (r && 0 < r.length);
          else
            var o = a(e).parent().attr("active-class"),
              r = a(e).children(o);
          0 < r.length
            ? n.css({
        ...
        showSubMenu: function (e) {
          ...
          if (0 < a(e).children(n).length) {
            ...
            r + i.outerWidth() > a(window).width() - 5 &&
              (r = a(window).width() - i.outerWidth() - 5),
              r < 5 && (r = 5),
              i.css({
                left: r,
              ...
              window.setTimeout(function () {
                i.addClass("show"),
                  i.attr("father-class", a(e).parent().parent().attr("class")),
                  i.attr("father-id", a(e).parent().parent().attr("id"));
              }, 1),
              i.first().data("father", a(e)),
              i.off("mouseenter").off("mouseleave"),
              i.hover(
                function () {
                  a(e).parent().data("subMenu_isActive", !0);
                },
                function () {
                  if ("click" == a("li").parent().parent().attr("sub-trigger"))
                    return !1;
                  s.hideSubMenu(this),
                    s.parseActivePosition(a(e).parent()),
                    a(e).parent().data("subMenu_isActive", !1);
                }
              );
          }
        },
        hideSubMenu: function (e) {
          a(e).removeClass("show"),
            window.setTimeout(function () {
              a(e).remove(),
                0 == a("body > .pandaTabWrap").children().length &&
                  a("body > .pandaTabWrap").remove();
            }, 250);
        },
        hideAllSubMenu: function (i) {
          a("body > .pandaTabWrap")
            .children()
            .each(function (e, t) {
              var n = a(i).attr("class")
                ? a(i).attr("class")
                : "fatherClass:undefined";
              (fatherId = a(i).attr("id")
                ? a(i).attr("id")
                : "fatherId:undefined"),
                (a(t).attr("father-class") != n &&
                  a(t).attr("father-id") != fatherId) ||
                  s.hideSubMenu(t);
            });
        },
        addHoverEvent: function (n) {
          a(n)
            ...
            .hover(
              function () {
                a(this).addClass("hover"),
                  s.parseActivePosition(a(this).parent()),
                  s.hideAllSubMenu(n),
                  s.showSubMenu(this),
                  n.attr("li-hovered", "");
              },
            ...
            a(n).mouseleave(function (e) {
              ...
              window.setTimeout(function () {
                a(t).data("subMenu_isActive") ||
                  (s.hideAllSubMenu(n), s.parseActivePosition(t));
              }, 50);
            });
        },
        addClickEvent: function (i) {
          a(i)
            ...
            .click(function () {
              s.hideAllSubMenu(i),
                a(this).hasClass("hover") || s.showSubMenu(this),
                a(this).siblings().removeClass("hover"),
                0 < a(this).find(a(i).attr("sub-class")).length &&
            ...
            a(i)
              ...
              .each(function (e, t) {
                ...
                0 < a(t).children(n).length &&
                  a(t).children("a").removeAttr("href");
              });
        },
        destroy: function (e) {
          a(e).children("ul").children(".anchor").remove(),
            a(e)
              .children("ul")
              .children()
              .off("mouseenter")
            ...
            s.hideAllSubMenu(e),
            s.hideScrolling(e),
            s.disableNativeScrolling(e),
            a(e).children("ul").removeData();
        },
          ...
          t.append(a(r).attr("next-text")),
            ...
            t.click(function (e) {
              var t = a(r).children("ul"),
                ...
                i = 400 < t.width() / 2 ? 400 : 0.75 * t.width(),
                o = 0;
              (o =
                t.scrollLeft() + i > n
                  ? n
                  : n - t.scrollLeft() - i < t.width() / 4
                  ? n
                  : t.scrollLeft() + i),
                t.animate(
                  {
                ...
                s.hideAllSubMenu(r),
                a(r).children("ul").children("li").removeClass("hover"),
                s.parseActivePosition(a(r).children("ul"));
            }),
            e.click(function (e) {
              var t = a(r).children("ul"),
                n =
                  (t.get(0).scrollWidth,
                  t.get(0).clientWidth,
                  400 < t.width() / 2 ? 400 : 0.75 * t.width()),
                i = 0;
              (i =
                t.scrollLeft() - n < 0
                  ? 0
                  : t.scrollLeft() - n < t.width() / 4
                  ? 0
                  : t.scrollLeft() - n),
                t.animate(
                  {
            ...
            a(r).children("ul").data("scrolling", !0),
            a(r).attr("has-scrolling-button", "");
        },
        hideScrolling: function (e) {
          a(e).children(".prev,.next").remove(),
            a(e).children("ul").removeAttr("style"),
            a(e).children("ul").removeData("scrolling"),
            a(e).children("ul").off("scroll"),
            a(e).removeAttr("has-scrolling-button");
        },
        autoScrolling: function (n) {
          if (!a(n).children("ul").data("pandaTab_init")) return !1;

          function i() {
            var e = a(n).children("ul");
            s.parseActivePosition(e),
              0 < e.get(0).scrollWidth - e.get(0).clientWidth &&
                s.makeScrolling(n),
              e.get(0).scrollWidth < a(n).get(0).scrollWidth &&
                s.hideScrolling(n),
              s.disableScrollingButton(n);
          }
          a(window).resize(function (e) {
            var t = a(n).attr("auto-scrolling");
            void 0 !== t && !1 !== t && i();
          }),
            i();
        },
        ...
        disableNativeScrolling: function (e) {
          ...
          a(e).removeAttr("style"),
            a(e).children("ul").removeClass("native-scrolling");
        },
        scrollToActivePosition: function (e) {
          ...
          var n = a(e).attr("active-class"),
            i = t.children(n);
          0 < i.length &&
            i.position().left + i.width() > t.width() &&
            (t.scrollLeft(i.position().left - t.width() / 2 + i.width() / 2),
            s.disableScrollingButton(e));
        },
      };
      switch (e) {
        case "makeScrolling":
  ...
  (jQVue.prototype.$renderer = {}),
  (jQVue.prototype.$writeBack = {}),
  (jQVue.prototype.$beforeMounted = {}),
  (jQVue.prototype.$beforeMounted.jv_element = function (e) {
    function n(e) {
      e = e || 32;
    ...
    (e = e || ""),
      $(e + " .jv-switcher").after(function () {
        if ("done" != $(this).data("jv_element")) {
          var e = n();
          return (
            $(this).attr("id", e),
            $(this).data("jv_element", "done"),
            '<label for="' + e + '"></label>'
          );
        }
      }),
  ...
  (jQVue.prototype.$isHuman = {
    ...
    check: function () {
      for (
        var e =
            jQVue.prototype.$isHuman.is_Mobile() ||
            jQVue.prototype.$isHuman.is_mac()
              ? jQVue.prototype.$isHuman.tapTimer
              : jQVue.prototype.$isHuman.clickTimer,
          t = 0,
          n = 0,
          i = 0;
        i < e.length;
        ...
        45 < e[i] && e[i] < 500 ? t++ : n++;
      return jQVue.prototype.$isHuman.is_Mobile()
        ? n < t && 2 <= t + n
        : n < t && 2 <= t + n && 8 < jQVue.prototype.$isHuman.mouseMove;
    },
    is_Mobile: function () {
      ...
      return !!(
        ...
        (-1 < e.indexOf("Android") || -1 < e.indexOf("Linux")) |
        (-1 < e.indexOf("iPhone")) |
        (-1 < e.indexOf("iPad"))
      );
    },
    ...
    window.setTimeout(function () {
      $("body")
        .mousedown(function (e) {
          (jQVue.prototype.$isHuman.temp.time = new Date().getTime()),
            (jQVue.prototype.$isHuman.temp.pageX = e.pageX),
            (jQVue.prototype.$isHuman.temp.pageY = e.pageY);
        })
        .mouseup(function (e) {
          if (
            jQVue.prototype.$isHuman.temp.pageX == e.pageX &&
            ...
            jQVue.prototype.$isHuman.clickTimer.push(
              t - jQVue.prototype.$isHuman.temp.time
            );
          }
        }),
        $("body").click(function () {
        ...
        $("body").on(
          "mousemove",
          "#cmt_form .submit-comment,#cmt_form .comment-input",
          function () {
  ...
  (function (e) {
    ...
    function _(e, t, a, n) {
      function l(e, t, n, i) {
        var o = '<span class="' + (i ? "" : $.classPrefix);
        return (o += e + '">') + t + (n ? "" : k);
      }
      function c() {
        (p +=
          null != h.sL
            ? (function () {
                ...
                if (e && !E[h.sL]) return b(f);
                var t = e
                  ? _(h.sL, f, !0, r[h.sL])
                  : x(f, h.sL.length ? h.sL : void 0);
                return (
                  0 < h.r && (m += t.r),
                  e && (r[h.sL] = t.top),
            ...
            : (function () {
                var e, t, n, i, o, r, s;
                if (!h.k) return b(f);
                for (i = "", t = 0, h.lR.lastIndex = 0, n = h.lR.exec(f); n; )
                  (i += b(f.substring(t, n.index))),
                    (o = h),
                    (r = n),
                    (s = d.cI ? r[0].toLowerCase() : r[0]),
                    (e = o.k.hasOwnProperty(s) && o.k[s])
                      ? ((m += e[1]), (i += l(e[0], b(n[0]))))
                      : (i += b(n[0])),
                    (t = h.lR.lastIndex),
                    (n = h.lR.exec(f));
      ...
      var f = "",
        m = 0;
      try {
        for (var s, g, v = 0; (h.t.lastIndex = v), (s = h.t.exec(t)); )
          (g = i(t.substring(v, s.index), s[0])), (v = s.index + g);
        for (i(t.substr(v)), o = h; o.parent; o = o.parent) o.cN && (p += k);
        return {
          r: m,
          value: p,
          language: e,
      ...
      var t,
        ...
        d = (function (e) {
          var t,
            ...
            r = e.className + " ";
          if (
            ((r += e.parentNode ? e.parentNode.className : ""), (n = T.exec(r)))
          )
            return C(n[1]) ? n[1] : "no-highlight";
          for (t = 0, i = (r = r.split(/\s+/)).length; t < i; t++)
            if (p((o = r[t])) || C(o)) return o;
        })(e);
      p(d) ||
        ($.useBR
    ...
    function C(e) {
      return (e = (e || "").toLowerCase()), E[e] || E[v[e]];
    }
    function r(e) {
      var t = C(e);
    ...
    return (
      ...
      (o.initHighlighting = n),
      (o.initHighlightingOnLoad = function () {
      ...
      o.registerLanguage("cs", function (e) {
        ...
        (r.c = [l, a, i, e.ASM, e.QSM, n, e.CBCM]),
          (s.c = [
            c,
            a,
            o,
  ...
  (function (o, i) {
          ...
          !(function e(t) {
            ...
            for (var i in n)
              if (n.hasOwnProperty(i)) {
                var o = n[i];
                0 < (o.textContent.trim().match(r) || []).length &&
                  (0 < o.childNodes.length ? e(o) : p(o.parentNode));
              }
          })(e),
              ...
              if (n.length > t) {
                for (var i = "", o = 0, r = n.length; o < r; o++)
                  i += m(
                    ...
                    [c, a, u, d, l, o + 1, 0 < n[o].length ? n[o] : " "]
                  );
    ...
    o.hljs
      ? ((o.hljs.initLineNumbersOnLoad = function (e) {
          "interactive" === i.readyState || "complete" === i.readyState
            ? t(e)
            : o.addEventListener("DOMContentLoaded", function () {
                t(e);
              });
        }),
        (o.hljs.lineNumbersBlock = h),
      ...
      : o.console.error("highlight.js not detected!");
  })(window, document),
  (function (e) {
    "use strict";
          ...
          (l = m(
            (l = m(
                  ...
                  (l = f(
                    (l = f(
                      (l = f(
                        (l = p(
                          ...
                          (c = p(
                            ...
                            (u = p(
                              u,
                              (a = p(a, l, c, u, e[n + 13], 5, -1444681467)),
                              l,
                              c,
                              e[n + 2],
                              9,
                      ...
                      (c = f(
                        ...
                        (u = f(
                          u,
                          (a = f(a, l, c, u, e[n + 1], 4, -1530992060)),
                          l,
                          c,
                          e[n + 4],
                          11,
                    ...
                    (c = f(
                      ...
                      (u = f(
                        u,
                        (a = f(a, l, c, u, e[n + 13], 4, 681279174)),
                        l,
                        c,
                        e[n],
                        11,
              ...
              (c = m(
                ...
                (u = m(
                  u,
                  (a = m(a, l, c, u, e[n + 12], 6, 1700485571)),
                  l,
                  c,
                  e[n + 3],
                  10,
            ...
            (c = m(
              ...
              (u = m(
                u,
                (a = m(a, l, c, u, e[n + 8], 6, 1873313359)),
                l,
                c,
                e[n + 15],
                10,
    ...
    function r(e, t) {
      return (function (e, t) {
        ...
        return (
          (i = l(r.concat(u(t)), 512 + 8 * t.length)), c(l(s.concat(i), 640))
        );
      })(n(e), n(t));
    }
    function t(e, t, n) {
  ...
  $(function () {
    (Mustache.escape = function (e) {
      ...
      (jQVue.prototype.$info = function (e, t) {
...
var e = function () {
  ...
  b = c(
    "Y29uc29sZS53YXJuKCdUaGVtZSBuaVJ2YW5hIHwgRGVzaWduZWQgYnkgbWljaGFlbGxpdW5za3lcbmh0dHBzOi8vbWljaGFlbGxpdW5za3kuY24nKQ=="
  ),
  f = function () {
    return a(c(g + "ik="));
  },
...
(k = function () {
  ...
  new jQVue({
    ...
    data: {
      ...
      chat_input: "",
      chat_nodata: d(
        "%E6%89%BE%E4%B8%8D%E5%88%B0%E7%9B%B8%E5%85%B3%E4%BF%A1%E6%81%AF"
      ),
    },
    mounted: function () {
      var t = this;
      this.load_blog_options(),
        0 < $("#coverflow[pandaSlider]").length && this.init_coverflow(),
        0 < $("#flatflow[pandaSlider]").length && this.init_flatflow(),
        this.init_sidebar(),
        0 < $(".topNav[pandaTab]").length && this.init_navbar(),
        0 < $(".categoryNav[pandaTab]").length && this.init_categoryNavbar(),
        0 < $(".display-switcher[pandaTab]").length &&
          this.init_displaySwitcher(),
        0 < $(".panda_pagi[pandaTab]").length && this.init_pagination(),
        this.parse_sidebar_height(),
        this.images_onload(function () {
        ...
        this.single_scrollspy(),
        $(document)
          .on("keyup", ".fullscreen_search .searchbox input", function (e) {
            $(this).prop("comStart") ||
              (e.preventDefault(),
              13 == (e.keyCode ? e.keyCode : e.which) && t.global_search());
          })
          .on(
            "compositionstart",
        ...
        window.mounted_hook && mounted_hook.call(this),
        $(".waterfall.postLists img").imgcomplete(function () {
          t.make_masonry();
        });
      try {
        baiduAudio.getToken();
      ...
      this.init_post_nav_smooth_scroll(),
        this.init_float_tools(),
        this.loadAssistance(),
        this.loadArticleDirtyStyle(),
        this.initLightbox(),
        $(".chat_input")
          .keyup(function (e) {
            $(this).prop("comStart") ||
              (e.preventDefault(),
              13 == (e.keyCode ? e.keyCode : e.which) && t.send_chat_message());
          })
        ...
        window.niRvana_ajax_render_complete ||
          (window.niRvana_ajax_render_complete = []),
        $(document).on("click", ".wechat-cover", function (e) {
          e.stopPropagation();
        });
    },
    methods: {
      init_coverflow: function () {
        ...
        if ("flat" != $("#coverflow[pandaSlider]").attr("type")) {
          if (n.is_Mac_Chrome() || n.is_Android()) {
            ...
            2 < (e = parseInt(e)) &&
              $("#coverflow[pandaSlider]").attr("view", "2");
          }
          if (n.is_Android()) {
            ...
            2 < (e = parseInt(e)) &&
              $("#coverflow[pandaSlider]").attr("view", "2"),
              $(
                ".home #coverflow[pandaSlider],.category #coverflow[pandaSlider],.single #coverflow[pandaSlider]"
              )
                .not("[type]")
                .attr("type", "flat");
          }
        ...
        $("#coverflow[pandaSlider]").pandaSlider("init", "", {
          ...
          onInit: function (e, t) {
            if ("image" == $("#coverflow[pandaSlider]").attr("type")) return !1;
            n.sliderIniteColorAndBlurImg(
              $("#coverflow[pandaSlider]").data().allPages
            ),
              n.sliderRenderBackground(e, t),
              (n.$waitColorInit = setInterval(function () {
                $(t).data("background-color") &&
                  (n.sliderRenderBackground(e, t),
                  clearInterval(n.$waitColorInit));
              }, 100));
          },
        }),
          "image" != $("#coverflow[pandaSlider]").attr("type") &&
            $("#coverflow").circleMagic({
              elem: "#coverflow",
              radius: 38,
              densety: 0.015,
      ...
      init_flatflow: function () {
        ...
        $("#flatflow[pandaSlider]").pandaSlider("init", "", {
          onInit: function () {
            $("#flatflow[pandaSlider]")
              .find(".navigator")
              .appendTo($("#flatflow[pandaSlider]").parent());
          },
        });
        var e = $("#flatflow .page"),
            ...
            if ((c = c.replace(/^url\(["']?/, "").replace(/["']?\)$/, ""))) {
              ...
              (u.crossOrigin = "anonymous"),
                (u.onload = function () {
                  ...
                  (t[2] = 40 <= t[2] ? 40 : t[2] <= 20 ? 20 : t[2]),
                    (t[1] = 10 < t[1] && t[1] < 70 ? 70 : t[1]);
                  var n =
                      "rgb(" +
                      (e = d.hslToRgb(t[0], t[1], t[2]))[0] +
                      "," +
                      e[1] +
                      "," +
                      e[2] +
                      ")",
                    i = t;
                  (i[0] = 0 < i[0] - 10 ? i[0] - 10 : i[0] - 10 + 360),
                    (i[1] = 20 < i[1] && i[1] < 50 ? 1.2 * i[1] : i[1]),
                    (i[2] =
                      i[2] < 30 ? 1.5 * i[2] : i[2] < 50 ? 1.2 * i[2] : i[2]);
                  var o = d.hslToRgb(i[0], i[1], i[2]),
                    r = "rgb(" + o[0] + "," + o[1] + "," + o[2] + ")";
                  if (
                    ($(l).css(
                      "background",
                      "linear-gradient(170deg," + n + " 30%," + r + ")"
                    ),
                    80 < t[2]
                      ? ($(l).find(".title").addClass("light_color"),
                        $(l).find(".description").addClass("light_color"))
                      : ($(l).find(".title").addClass("dark_color"),
                        $(l).find(".description").addClass("dark_color")),
                    d.canFilterBlur())
                  ) {
                    $(l).attr("blured", "css");
                    var s = $("<div>");
                    s.addClass("filterBlured"),
                      s.css("background-image", "url(" + c + ")");
                    var a = $("<div>");
                    a.addClass("filterBlured_wrap"),
                      a.append(s),
                      $(l).append(a);
                  }
                }),
      ...
      sliderRenderBackground: function (e, t) {
        var n = $(t).find(".card").css("background-image"),
          i =
            ...
            $("<div>"));
        if (
          (i.addClass("imgColor").css({
            background: $(t).data("background-color")
              ? $(t).data("background-color")
              : "linear-gradient(120deg,#2c4867,#6187af)",
            display: "none",
          }),
          $(t).hasClass("hasHeadImg") || $("#coverflow").append(i),
          1 == $("#coverflow .imgColor").length
            ? i.delay(0).fadeIn(100)
            : i.delay(100).fadeIn(500),
          $("#coverflow .imgColor")
            .not(i)
            .delay(700)
            .fadeOut(0, function () {
          ...
          (i = null),
          "flat" != $("#coverflow[pandaSlider]").attr("type") &&
            $(t).data("background-image"))
        ) {
          var o = $("<div>");
          o.addClass("imgBlur").css({
            ...
            $(window).width() < 768 && o.css("animation-duration", "5s"),
            1600 < $(window).width() && o.css("animation-duration", "15s"),
            this.is_chrome() && o.addClass("noAnimation"),
            $(t).hasClass("hasHeadImg") &&
              o.addClass("useHeadImg").css({
                "background-image": "url(" + $(t).attr("headImg") + ")",
              }),
            $("#coverflow").append(o),
            o.delay(100).fadeIn(500),
            $("#coverflow .imgBlur")
              .not(o)
              .delay(700)
              .fadeOut(0, function () {
        ...
        var r = $(t).data("main-color")
          ? $(t).data("main-color")
          : "dark-slider";
        $("body")
          .removeClass("dark-slider")
          .removeClass("light-slider")
          .addClass(r);
      },
          ...
          if (n) {
            ...
            (g.crossOrigin = "anonymous"),
              (g.onload = function () {
                ...
                (i[2] = 40 <= i[2] ? 40 : i[2] <= 15 ? 15 : i[2]),
                  (i[1] = 10 < i[1] && i[1] < 40 ? i[1] + 10 : i[1]),
                  i[2] <= 70
                    ? $(m).data("main-color", "dark-slider")
                    : $(m).data("main-color", "light-slider");
                var o =
                    "rgb(" +
                    (n = v.hslToRgb(i[0], i[1], i[2]))[0] +
                    "," +
                    n[1] +
                    "," +
                    n[2] +
                    ")",
                  r = i;
                (r[0] = 0 < r[0] - 15 ? r[0] - 15 : r[0] - 15 + 360),
                  (r[1] = 20 < r[1] && r[1] < 50 ? 1.2 * r[1] : r[1]),
                  (r[2] =
                    r[2] < 30 ? 1.5 * r[2] : r[2] < 50 ? 1.2 * r[2] : r[2]);
                var s = v.hslToRgb(r[0], r[1], r[2]),
                  a = "rgb(" + s[0] + "," + s[1] + "," + s[2] + ")";
                if (
                  ($(m).data(
                    "background-color",
                    "linear-gradient(120deg," + o + " 20%," + a + " 80%)"
                  ),
                  "flat" != $("#coverflow[pandaSlider]").attr("type"))
                ) {
                  var l = g.width,
      ...
      canFilterBlur: function () {
        return (
          !!!(!window.CSS || !window.CSS.supports) &&
          CSS.supports(
            "(filter: blur(25px) brightness(0.9) contrast(1.3)) or (-webkit-filter: blur(25px) brightness(0.9) contrast(1.3))"
          )
        );
      },
      ...
      rgbToHsl: function (e, t, n) {
        ...
        if (r == s) i = o = 0;
          ...
          var l = r - s;
          switch (((o = 0.5 < a ? l / (2 - r - s) : l / (r + s)), r)) {
            case e:
              i = (t - n) / l + (t < n ? 6 : 0);
              break;
            case t:
      ...
      init_sidebar: function () {
        ...
        if (
          ...
          $('[manual-template="sidebar"]').html(d(this.sidebar)),
          0 == $("aside").length)
        )
          return !1;
        if (
          ($(".sidebarMenu[pandaTab]").each(function (e, t) {
            $(t).pandaTab();
          }),
          ...
          $(document).on(
            "click",
            "#wrapper.sidebar-visible #main",
            function (e) {
              $("#wrapper").removeClass("sidebar-visible");
            }
          ),
          0 < $('.single .sidebarMenu li[data-id="sidebar-0"]').length)
        )
          $('.single .sidebarMenu li[data-id="sidebar-0"]').click();
        else
          for (
            var n = ["archive", "single", "home", "page"], o = !0, r = 0;
            r < n.length && o;
            r++
          )
            $("." + n[r] + " .sidebarMenu").each(function (e, t) {
              $(t)
                .find("li[show-on-" + n[r] + "]")
                .first()
                .click(),
      ...
      parse_sidebar_height: function () {
        ...
        var i = this;
        (e = 240 < e ? e : 240),
          $('[manual-template="sidebar"]').height(e - 15),
          $('[manual-template="sidebar"]').custom_scrollbar({
            scrollbarClassName: "scrollBar-background",
            scrollbarWidth: 6,
            scrollbarTrackColor: "transparent",
            scrollbarColor: "rgba(31,45,61,.2)",
          }),
          $(".custom-scrollbar-content-wrapper").data("hasScrollingEvent") ||
            ($(".custom-scrollbar-content-wrapper").data(
              "hasScrollingEvent",
              !0
            ),
            $(".custom-scrollbar-content-wrapper").scroll(function (e) {
              clearTimeout(i.sidebarScrollingTimeOut),
                $(this)
                  .siblings()
                  .find(".scrollBar-background")
                  .addClass("scrolling");
              var t = this;
      ...
      init_displaySwitcher: function () {
        ...
        $(".display-switcher[pandaTab]").each(function (e, t) {
          ...
          $(".display-switcher[pandaTab] li.list").click(function (e) {
            $('[height-to="sidebar"].cards').addClass("disappear"),
              window.setTimeout(function () {
                $('[height-to="sidebar"].cards')
          ...
          $(".display-switcher[pandaTab] li.card").click(function (e) {
            $('[height-to="sidebar"].lists').addClass("disappear"),
              window.setTimeout(function () {
                $('[height-to="sidebar"].lists')
                  .removeClass("disappear")
                  .removeClass("lists")
                  .addClass("cards"),
                  n.make_masonry();
          ...
          $(".display-switcher[pandaTab] li").click(function () {
            $(this).addClass("active"),
              $(this).siblings().removeClass("active"),
              $(this).parent().parent().pandaTab("parseActivePosition"),
              window.setTimeout(function () {
      ...
      init_navbar: function () {
        ...
        $(".topNav[pandaTab]").pandaTab(),
          this.is_Mobile() &&
            $(".topNav[pandaTab]").pandaTab("useNativeScrolling"),
          e(),
      ...
      init_categoryNavbar: function () {
        $(".categoryNav[pandaTab]").pandaTab(),
          this.is_Mobile() &&
            $(".categoryNav[pandaTab]").pandaTab("useNativeScrolling");
      },
      parse_nav_class_style: function (e) {
        var t = "float";
        return (
          0 < $(".container #coverflow").length &&
            $(window).scrollTop() < 20 &&
            992 <= $(window).width() &&
            (t = "flat"),
          t
      ...
      toggle_mobile_menu: function () {
        $("#wrapper").hasClass("sidebar-visible")
          ? this.$message(
              d(
                "%E6%9C%AC%E4%B8%BB%E9%A2%98%E7%94%B1%E2%80%9C%E5%88%98%E6%AC%A2%E2%80%9D%E5%BC%80%E5%8F%91"
              )
            )
          : $("#wrapper").toggleClass("menu-wrap-visible");
      },
      toggle_mobile_sidebar: function () {
        $("#wrapper").hasClass("menu-wrap-visible")
          ? this.$message(
              d(
                "%E6%9C%AC%E4%B8%BB%E9%A2%98%E7%94%B1%E2%80%9C%E5%88%98%E6%AC%A2%E2%80%9D%E5%BC%80%E5%8F%91"
              )
      ...
      show_global_search: function () {
        ...
        $(".fullscreen_search").html(e),
          this.$beforeMounted.jv_element(".fullscreen_search"),
          this.blur_front(),
          $(".fullscreen_search").addClass("visible"),
          this.$rerender();
      },
      hide_global_search: function () {
        $(".fullscreen_search").removeClass("visible"),
          this.return_blur_front(),
          window.setTimeout(function () {
            $(".fullscreen_search").empty();
          }, 250);
      },
      global_search_toggle_advanced: function () {
        $(".fullscreen_search .advanced").toggleClass("open"),
          $(".fullscreen_search .checkbox-group").slideToggle();
      },
      global_search: function () {
        var n = this;
        if ("" == this.global_search_query)
          return (
            this.$alert(
              d(
                "%E8%AF%B7%E8%BE%93%E5%85%A5%E6%90%9C%E7%B4%A2%E5%85%B3%E9%94%AE%E8%AF%8D%EF%BC%81"
              )
            ),
            !1
          );
        var e = [];
        if (
          (this.global_search_post && e.push("post"),
          this.global_search_gallery && e.push("gallery"),
          0 == e.length)
        )
          return (
            $(".fullscreen_search .advanced").hasClass("open") ||
              this.global_search_toggle_advanced(),
            this.$alert(
              d(
                "%E8%87%B3%E5%B0%91%E9%80%89%E6%8B%A9%E4%B8%80%E7%A7%8D%E7%B1%BB%E5%9E%8B%E5%86%8D%E6%90%9C%E7%B4%A2%EF%BC%81"
              )
            ),
            !1
          );
        $(".fullscreen_search .searchbox .button .icon").empty(),
          $(".fullscreen_search .searchbox .button .icon").append(
            '<i class="fas fa-circle-notch fa-spin"></i>'
          ),
          $(".fullscreen_search .advanced").hasClass("open") &&
            this.global_search_toggle_advanced(),
          $(".fullscreen_search .searchbox input").attr("disabled", "disabled"),
          $(".fullscreen_search .searchbox .button").attr(
            "disabled",
            "disabled"
          ),
          $(".fullscreen_search .postLists").removeClass("visible"),
          $.ajax({
            ...
            data: JSON.stringify({
              ...
              arg: {
                search_prod_title: n.global_search_prod_title
                  ? n.global_search_query
                  : "",
                ...
                (e = $(e)),
                  n.is_Mobile() &&
                    $(e)
                      .find(".card")
                      .removeClass("card")
                      .addClass("low_cpu_card"),
                  $(".fullscreen_search .postLists").html(e),
                  $(".fullscreen_search .postLists img").imgcomplete(
                    function () {
                      n.make_masonry();
                    }
                  ),
                  $(".fullscreen_search .postLists").addClass("visible"),
                  $(".fullscreen_search .searchbox").css("margin-top", "10vh"),
                  $(".fullscreen_search .searchbox .button .icon").empty(),
                  $(".fullscreen_search .searchbox .button .icon").append(
                    '<i class="fas fa-search"></i>'
                  ),
                  $(".fullscreen_search .searchbox input").removeAttr(
                    "disabled"
                  ),
                  $(".fullscreen_search .searchbox .button").removeAttr(
                    "disabled"
                  );
              }, 300);
            })
            .fail(function () {
              n.$alert(
                d(
                  "<b>%E7%BD%91%E7%BB%9C%E9%94%99%E8%AF%AF</b><br>%E8%AF%B7%E5%88%B7%E6%96%B0%E5%90%8E%E5%86%8D%E8%AF%95%EF%BC%81"
                )
              );
            });
      },
      ...
      load_blog_options: function () {
        ...
        $.ajax({
          ...
          forceCache: t.forceCache,
          beforeSend: function (e) {
            e.setRequestHeader("x-wp-nonce", pandastudio_framework.nonce);
          },
        })
          .done(function (e) {
            e.error && t.enable_pageLoader(e.msg),
              e.ajax_forceCache && (t.forceCache = !0),
              e.enable_pageLoader && t.init_pageLoader(),
              e.is_user_loggedin && (t.is_user_loggedin = e.is_user_loggedin),
              e.cmt_req_name_email &&
                (t.comment_require_name_email = e.cmt_req_name_email),
              e.cmt_action_url && (t.comment_action_url = e.cmt_action_url),
              e.chat_nodata && (t.chat_nodata = e.chat_nodata),
              (t.optionsLoaded = !0),
              $(".comment-meta.nick-name.guests").popover({
                container: "body",
                animation: !0,
              ...
              e.enable_highlightjs &&
                $("article pre").each(function (e, t) {
                  var n = $(t).children("code");
                  return (
                    (t = 0 < n.length ? n.get(0) : t),
                    !$(t).hasClass("hljs") &&
                      !$(t).parent().hasClass("disable_highlightjs") &&
                      (hljs.highlightBlock(t),
                      void hljs.lineNumbersBlock(t, {
                        singleLine: !0,
                      }))
                  );
                });
          ...
          .fail(function () {
            window.setTimeout(function () {
              t.$alert(
                "<b>REST API请求错误</b><br>服务器地址重写错误，检查<br>1、“后台/设置/固定链接”设置为朴素<br>2、“.htaccess文件是否配置有误”",
                1e3
              );
            }, 2e3);
          });
      ...
      init_pageLoader: function () {
        ...
        $(document).on(
          "click",
          'a[href]:not([target="_blank"]):not([onclick])',
          function (e) {
            if (!(0 < $(this).parents("#comments,.popover").length)) {
              ...
              if (
                t &&
                "#" != t.charAt(0) &&
                $(window).data("pageLoader_enable") &&
                !s.url_is_image(t)
              )
                try {
                  history.pushState({}, "", t),
                    e.preventDefault(),
                    $(window).trigger("pageLoader:start", [t]),
                    $.ajax({
                      url: t,
                      type: "GET",
                      dataType: "html",
          ...
          $(window).on("popstate", function (e) {
            if (history.state) {
              ...
              $('[jqvue-template="sidebarMenu"]').html(o),
                $('[jqvue-template="sidebar"]').html(r),
                (s.sidebarMenu = o),
                (s.sidebar = r),
                s.$beforeMounted.jv_element(),
                s.$mounted();
            }
          }),
          $(window).data("pageLoader_enable", !0),
          $(window).on("pageLoader:start", function (e, t) {
            s.enable_pageLoader("");
          }),
          ...
          $(window).on("pageLoader:success", function (e, t, n) {
            ...
            o.hasClass("niRvana")
              ? ((t = t.replace(/\/$/gi, "")),
                ...
                $(".nav").addClass("before_view"),
                $("#main").addClass("before_view"),
                window.setTimeout(function () {
                  $("#wrapper").remove(),
                    $(".popover").remove(),
                    $(".tooltip").remove(),
                    $(".wechat-cover-wrapper").remove(),
                    s.hide_global_search(),
                    o.find(".nav").addClass("before_view"),
                    o.find("#main").addClass("before_view"),
                    $("body").prepend(o);
                  var e = i.find('[jqvue-template="sidebarMenu"]').html(),
                    t = i.find('[jqvue-template="sidebar"]').html();
                  $('[jqvue-template="sidebarMenu"]').html(e),
                    $('[jqvue-template="sidebar"]').html(t),
                    (s.sidebarMenu = e),
                    (s.sidebar = t),
                    $(window).scrollTop(0),
                    s.$rerender(),
                    ...
                    s.$mounted(),
                    window.setTimeout(function () {
                      o.find(".nav").removeClass("before_view"),
                        o.find("#main").removeClass("before_view"),
                        (document.title = i.find("title").html());
                      try {
                        for (
                          var e = 0;
                          e < window.niRvana_ajax_render_complete.length;
                          e++
                        )
                          window.niRvana_ajax_render_complete[e]();
                      } catch (e) {}
                    }, 16);
                }, 250))
              : location.reload();
        ...
        if ("submit" == $(e.target).attr("type"));
          ...
          if (
            (this.is_user_loggedin ||
              (("" == this.comment_author.replace(/ /g, "")) &
                this.comment_require_name_email &&
                t.push(d("%E6%98%B5%E7%A7%B0%E6%9C%AA%E5%A1%AB%E5%86%99")),
              ("" == this.comment_email.replace(/ /g, "")) &
                this.comment_require_name_email &&
                t.push(d("%E9%82%AE%E7%AE%B1%E6%9C%AA%E5%A1%AB%E5%86%99")),
              ("" != this.comment_email.replace(/ /g, "")) &
                !this.is_Email(this.comment_email) &&
                t.push(
                  d("%E9%82%AE%E7%AE%B1%E6%A0%BC%E5%BC%8F%E9%94%99%E8%AF%AF")
                )),
            0 < t.length &&
              this.optionsLoaded &&
              window.setTimeout(function () {
            ...
            "" == this.comment_text.replace(/ /g, "") &&
              (t.push(
                d(
                  "%E8%AF%84%E8%AE%BA%E5%86%85%E5%AE%B9%E6%9C%AA%E5%A1%AB%E5%86%99"
                )
              ),
              0 == t.length && $("#comment").trigger("focus")),
            0 < t.length && this.$alert(t.toString().replace(/,/g, "<br>")),
            !this.$isHuman.check() && 0 == t.length)
          )
            return (
              this.enable_pageLoader(
                d(
                  "<b>%E4%B8%A5%E9%87%8D%E9%94%99%E8%AF%AF%EF%BC%9A%E9%9D%9E%E4%BA%BA%E4%B8%BA%E6%93%8D%E4%BD%9C</b><br>%E6%93%8D%E4%BD%9C%E8%BF%87%E5%BF%AB%EF%BC%8C%E5%88%A4%E5%AE%9A%E4%B8%BA%E6%9C%BA%E5%99%A8%E4%BA%BA%E6%93%8D%E4%BD%9C%EF%BC%8C%E8%AF%B7%E5%88%B7%E6%96%B0%E9%87%8D%E8%AF%95"
                )
              ),
              !1
            );
          if (0 == t.length && this.$isHuman.check()) {
            ...
            var n = $('<input name="wp_nonce" class="hidden">');
            if (
              (n.val(pandastudio_framework.nonce),
              $("#cmt_form").append(n),
              !this.comment_action_url)
            )
              return (
                this.enable_pageLoader(
                  d(
                    "<b>%E4%B8%A5%E9%87%8D%E9%94%99%E8%AF%AF%EF%BC%9A%E8%AF%84%E8%AE%BA%E5%9C%B0%E5%9D%80%E6%97%A0%E6%95%88</b><br>%E8%AF%B7%E8%81%94%E7%B3%BB%E5%94%AE%E5%90%8E%E6%88%96%E6%A0%B9%E6%8D%AE%E6%89%8B%E5%86%8C%E6%A3%80%E6%9F%A5%E9%97%AE%E9%A2%98"
                  )
                ),
                !1
              );
            $("#cmt_form").attr("action", this.comment_action_url),
      ...
      init_comments: function () {
        var t = this;
        if (
          ($(".commentlist .children > li").each(function (e, t) {
            var n =
              "<span class='reply'>@" +
              $(this).parent().siblings().find(".name").html() +
              "</span>";
            $(this)
              .find(".comment-author.vcard")
              .first()
              .find("p")
              .first()
              .prepend(n);
          ...
          $(".comment-meta.nick-name.loggedin").popover({
            ...
            trigger: "focus",
            title: d(
              '<i class="fas fa-sign-out-alt"></i> %E9%80%80%E5%87%BA%E7%99%BB%E5%BD%95%EF%BC%9F'
            ),
          }),
            ...
            t.optionsLoaded
              ? ($(".comment-meta.nick-name.guests").popover("show"),
                "" != t.comment_author
                  ? "" != t.comment_email
                    ? "" != t.comment_url ||
                      $('.popover [v-model="comment_url"]').focus()
                    : $('.popover [v-model="comment_email"]').focus()
                  : $('.popover [v-model="comment_author"]').focus())
              : t.message(
                  d(
                    "<b>%E8%AF%B7%E7%A8%8D%E5%90%8E</b><br>%E7%BD%91%E9%A1%B5%E8%BF%98%E6%9C%AA%E5%8A%A0%E8%BD%BD%E5%AE%8C%E6%88%90"
                  )
                );
          }),
          $("body").click(function (e) {
            $(e.target).is(".comment-meta.nick-name.guests") ||
              0 != $(e.target).parents(".popover").length ||
              ($(e.target).is("textarea#comment") &&
                t.comment_require_name_email &&
                ("" == t.comment_author || "" == t.comment_email)) ||
              $(".comment-meta.nick-name.guests").popover("hide");
          }),
          $("textarea#comment").click(function (e) {
            if (
              ...
              if (
                ...
                return void $('.popover [v-model="comment_author"]').focus();
              if ("" == t.comment_email)
                return void $('.popover [v-model="comment_email"]').focus();
            }
          }),
          localStorage.pandastudio_guest_info)
        ) {
          var e = JSON.parse(localStorage.pandastudio_guest_info);
          (this.comment_author = e.comment_author),
            (this.comment_email = e.comment_email),
            (this.comment_url = e.comment_url);
        }
      },
      ...
      single_toggle_sidebar: function (e) {
        ...
        function n() {
          $(".postListsModel > .row > div")
            .eq(0)
            .attr("class", "col-md-9 col-lg-9_5"),
            window.setTimeout(function () {
              $(".postListsModel > .row > div")
                .eq(1)
                .attr("class", "col-md-3 col-lg-2_5 hidden-xs hidden-sm"),
                t.parse_sidebar_width(),
                $(window).scrollTop($(window).scrollTop() + 1),
                $(window).scrollTop($(window).scrollTop() - 1),
                $(".sidebarMenu li.active").click();
            }, 500);
        }
        function i() {
          $(".postListsModel > .row > div")
            .eq(0)
            .attr("class", "col-xs-12 no-sidebar"),
            $(".postListsModel > .row > div").eq(1).attr("class", "hidden");
        }
        "show" == e
          ? n()
          : "hide" == e
          ? i()
          : $(".postListsModel > .row > div").eq(0).hasClass("no-sidebar")
          ? n()
          : i();
      },
      ding: function (e) {
        var t = this;
        $(".post-like.like.favorite").hasClass("done")
          ? this.$alert(
              d(
                "%E6%82%A8%E5%B7%B2%E7%BB%8F%E7%82%B9%E8%BF%87%E8%B5%9E%E4%BA%86%EF%BC%81"
              )
            )
          : ($(".post-like.like.favorite > .count.number").html(
              '<i class="fas fa-circle-notch fa-spin"></i>'
            ),
            $.ajax({
              url: pandastudio_framework.route + "pandastudio/nirvana/restapi/",
              ...
              .done(function (e) {
                $(".post-like.like.favorite > .count.number").html(e),
                  $(".post-like.like.favorite").addClass("done"),
                  $(".post-like.like.favorite i")
                    .removeClass("far")
                    .addClass("fas"),
                  window.setTimeout(function () {
                    t.$message(
                      d(
                        "%E5%B7%B2%E8%B5%9E%EF%BC%8C%E6%84%9F%E8%B0%A2%E6%82%A8%E7%9A%84%E6%94%AF%E6%8C%81%EF%BC%81"
                      )
                    );
                  }, 1e3),
      ...
      gallery_bgsize_toggle: function () {
        "cover" == $('#coverflow.gallery[type="image"]').attr("background-size")
          ? $('#coverflow.gallery[type="image"]').attr(
              "background-size",
              "contain"
            )
          : $('#coverflow.gallery[type="image"]').attr(
      ...
      send_chat_message: function (e) {
        ...
        this.chat_msg.push({
          ...
          !e && (this.chat_input = ""),
          this.renderChat(),
          (this.send_chat_message_loading = window.setTimeout(function () {
            i.chat_loading(!0);
          }, 250)),
          $.ajax({
            url: pandastudio_framework.route + "pandastudio/nirvana/restapi/",
            ...
            .done(function (e) {
              ...
              if (e.is_content)
                ...
                t = d(
                  "%E6%89%BE%E5%88%B0%E4%BB%A5%E4%B8%8B%E5%86%85%E5%AE%B9%EF%BC%8C%E7%82%B9%E5%87%BB%E6%9F%A5%E7%9C%8B%E8%AF%A6%E6%83%85<ol>"
                );
                for (var n = 0; n < e.list.length; n++)
                  t +=
                    "<li><span @click='this.send_chat_message(\"" +
                    e.list[n] +
                    "\")'>" +
                    e.list[n] +
                    "</span></li>";
            ...
            .fail(function () {
              i.chat_msg.push({
                user: "server",
                content: d(
                  "%E6%95%B0%E6%8D%AE%E5%8A%A0%E8%BD%BD%E5%A4%B1%E8%B4%A5"
                ),
              });
            })
            .always(function () {
              window.clearTimeout(i.send_chat_message_loading),
                i.chat_loading(!1);
            });
      },
      renderChat: function () {
        ...
        $("#chatTemplate").html(t),
          $("#chatTemplate").css("max-height", "inherit");
        var n = $("#chatTemplate").height();
        $("#chatTemplate").attr("style", ""),
          $("#chatTemplate").scrollTop(e),
          $("#chatTemplate").animate(
            {
              scrollTop: n - 400 + 15,
            },
            200
      ...
      init_float_tools: function () {
        $("#wrapper").append(this.floatTools),
          $(window).scroll(function (e) {
            300 < $(window).scrollTop()
              ? $(".floatTools .tool-button.backToTop").removeClass(
                  "unavailable"
                )
              : $(".floatTools .tool-button.backToTop").addClass("unavailable");
          });
      },
      backToTop: function () {
        $("html,body").animate(
      ...
      shareToWechat: function (e, t) {
        0 == $("script#html2canvas").length &&
          $("body").append(
            '<script src="' +
              pandastudio_framework.theme.route +
              '/assets/minify/html2canvas.min.js" id="html2canvas"></script>'
          ),
          0 == $(".wechat-cover").length &&
            $("body").append(
              '<div class="wechat-cover-wrapper unavailable" @click="this.hide_wechat_cover()">'
            );
        var n = location.href,
          i = {
            title: $("h1").html(),
        ...
        $(".wechat-cover-wrapper").html(o),
          $(".wechat-cover-wrapper").removeClass("unavailable"),
          $(".wechat-cover-wrapper .qrcode").qrcode({
            width: 100,
            height: 100,
            correctLevel: 0,
          ...
          window.setTimeout(function () {
            html2canvas($(".wechat-cover-wrapper .renderCoverImg").get(0), {
              ...
              (t.mozImageSmoothingEnabled = !1),
                ...
                $(".wechat-cover-wrapper .renderCoverImg").empty(),
                $(".wechat-cover-wrapper .renderCoverImg").append(
                  '<img src="' + e.toDataURL() + '">'
                ),
                $(".wechat-cover .wait span").html(
                  d(
                    "%E5%B0%81%E9%9D%A2%E5%B7%B2%E7%94%9F%E6%88%90%EF%BC%81%E4%BF%9D%E5%AD%98%E5%9B%BE%E7%89%87%E5%8F%AF%E5%88%86%E4%BA%AB%E8%87%B3%E7%A4%BE%E4%BA%A4%E7%BD%91%E7%AB%99"
                  )
                ),
                $(".wechat-cover .wait span").addClass("success");
            });
          }, 750);
      },
      hide_wechat_cover: function () {
        this.return_blur_front(),
          $(".wechat-cover-wrapper").addClass("unavailable");
      },
      utf16to8: function (e) {
        var t, n, i, o;
        for (t = "", i = e.length, n = 0; n < i; n++)
          1 <= (o = e.charCodeAt(n)) && o <= 127
            ? (t += e.charAt(n))
            : (2047 < o
                ? ((t += String.fromCharCode(224 | ((o >> 12) & 15))),
                  (t += String.fromCharCode(128 | ((o >> 6) & 63))))
                : (t += String.fromCharCode(192 | ((o >> 6) & 31))),
        ...
        $("#wrapper").on(
          ...
          (myFunc = function (e) {
            ...
            n &&
              ...
              i.url_is_image(n) &&
              (e.preventDefault(), i.makeLightbox(n, e, t));
          })
        ),
          $("#wrapper").on(
            "click",
      ...
      makeLightbox: function (e, t, n) {
        ...
        $("#wrapper").append(i),
          i.data("windowScrollTop", $(window).scrollTop()),
          i.data("clientX", t.clientX),
          i.data("clientY", t.clientY);
        ...
        if (e) n.remove();
          ...
          var i = n.find("img"),
            ...
            r =
              n.data("clientY") -
              $(window).scrollTop() +
              n.data("windowScrollTop"),
            s = $(window).width() / 2 - o,
            a = $(window).height() / 2 - r;
          i.css(
            "transform-origin",
            "calc(50% - " + s + "px) calc(50% - " + a + "px)"
          ),
            i.addClass("unvisible"),
            window.setTimeout(function () {
              t.clearLightbox(!0);
            }, 500);
        }
      ...
      insert_code_to_comment_form: function () {
        ...
        "" == this.comment_text
          ? (this.comment_text += e)
          : "\n" == this.comment_text.substring(this.comment_text.length - 1)
          ? (this.comment_text += e)
          : (this.comment_text += "\n<pre>\n请输入代码...\n</pre>"),
        ...
        new PdMessage().prompt({
          ...
          then: function (e) {
            ...
            t.map(function (e) {
              ...
              "" == i.comment_text
                ? (i.comment_text += n)
                : "\n" == i.comment_text.substring(i.comment_text.length - 1)
                ? (i.comment_text += n)
                : (i.comment_text += "\n" + n),
              $("textarea#comment").focus();
          },
      ...
      (u.htmlInit = function (a, l) {
        u.docReady(function () {
          ...
          i.forEach(function (t) {
            var e,
              n = t.getAttribute(o) || t.getAttribute(r);
            try {
              e = n && JSON.parse(n);
            } catch (e) {
              return void (
                d &&
                d.error("Error parsing " + o + " on " + t.className + ": " + e)
              );
            }
            var i = new a(t, e);
            s && s.data(t, l, i);
  ...
  $.ajaxPrefilter(function (e, t, n) {
    if (t.forceCache) {
      var i = {
        ...
        o = JSON.stringify(i);
      "object" != typeof window._ajaxForceCache &&
        (window._ajaxForceCache = {}),
        window._ajaxForceCache[o] ||
