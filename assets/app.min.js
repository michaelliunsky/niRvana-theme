...
if (
  ((function (e, t) {
    ...
    var p = (function (n) {
      ...
      try {
        I.apply((t = A.call(k.childNodes)), k.childNodes),
          ...
          if ((o = G.exec(e)))
            if ((s = o[1])) {
              ...
              if (
                ...
                return I.apply(n, t.getElementsByClassName(s)), n;
            }
          if (f.qsa && (!b || !b.test(e))) {
            if (
              ((d = u = C),
          ...
          return l !== x && 9 === l.nodeType && l.documentElement
            ? ((o = (x = l).documentElement),
              ...
              (w.find.CLASS =
                f.getElementsByClassName &&
                function (e, t) {
                  return typeof t.getElementsByClassName !== N && v
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      (!f.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === l || (e.ownerDocument === k && y(k, e))
                          ? -1
                          : t === l || (t.ownerDocument === k && y(k, t))
                          ? 1
                          : c
                          ? L.call(c, e) - L.call(c, t)
                          : 0
                        : 4 & n
                        ? -1
                        : 1)
      ...
      return (
        ...
        (f.sortStable = C.split("").sort($).join("") === C),
        ...
        function (i, o) {
          C.fn[i] = function (e, t) {
            ...
            return (
              ...
              1 < this.length &&
                (N[i] || C.unique(n), $.test(i) && n.reverse()),
              this.pushStack(n)
            );
          };
        }
        ...
        remove: function (e, t) {
          ...
          if (void 0 === t) this.cache[r] = {};
            ...
            n = (i = C.isArray(t)
              ...
              : ((o = C.camelCase(t)),
                t in s ? [t, o] : (i = o) in s ? [i] : i.match(M) || []))
              .length;
            for (; n--; ) delete s[i[n]];
          }
        },
    ...
    C.extend({
      ...
      C.fn.extend({
        data: function (i, e) {
          ...
          if (
            this.length &&
            ((o = j.get(r)), 1 === r.nodeType && !D.get(r, "hasDataAttrs"))
          ) {
            for (t = s.length; t--; )
        ...
        if (
          ...
          for (o = 0; (r = d[o++]) && !e.isPropagationStopped(); )
            (e.type = 1 < o ? a : u.bindType || h),
              (c = (D.get(r, "events") || {})[e.type] && D.get(r, "handle")) &&
                c.apply(r, t),
              (c = l && r[l]) &&
                c.apply &&
                C.acceptData(r) &&
          ...
          function (n, i) {
            ...
            C.event.special[i] = {
              ...
              teardown: function () {
                ...
                t
                  ? D.access(e, i, t)
                  : (e.removeEventListener(n, o, !0), D.remove(e, i));
              },
            };
          }
        ),
    ...
    function he(e, t) {
      ...
      if (1 === t.nodeType) {
        if (
          D.hasData(e) &&
          ((r = D.access(e)), (s = D.set(t, r)), (c = r.events))
        )
    ...
    function Le(e, t) {
      for (var n, i, o, r = [], s = 0, a = e.length; s < a; s++)
        (i = e[s]).style &&
          ((r[s] = D.get(i, "olddisplay")),
          (n = i.style.display),
          t
            ? (r[s] || "none" !== n || (i.style.display = ""),
              "" === i.style.display &&
                W(i) &&
                (r[s] = D.access(i, "olddisplay", ve(i.nodeName))))
            : r[s] ||
              ((o = W(i)),
              ((n && "none" !== n) || !o) &&
                D.set(i, "olddisplay", o ? n : C.css(i, "display"))));
      for (s = 0; s < a; s++)
        (i = e[s]).style &&
        ...
        C.cssHooks[o] = {
          ...
          set: function (e, t, n) {
            ...
            return Me(
              ...
              t,
              n
                ? Ie(e, o, n, "border-box" === C.css(e, "boxSizing", !1, i), i)
                : 0
            );
          },
        };
    ...
    (C.Animation = C.extend(Ve, {
      ...
      ((Be = b.createElement("input")).value = "t"),
      (Be.type = "radio"),
      (v.radioValue = "t" === Be.value);
    var Ye,
          ...
          : this.each(
              C.isFunction(o)
                ...
                : function () {
                    if ("string" === r)
                      for (
                        var e, t = 0, n = C(this), i = o.match(M) || [];
                        (e = i[t++]);
    ...
    return (
      (C.noConflict = function (e) {
        return (
          f.$ === C && (f.$ = At), e && f.jQuery === C && (f.jQuery = It), C
        );
      }),
    ...
    (function (c, u, e) {
      ...
      (function (a, e) {
        ...
        (a.ui = a.ui || {}),
          ...
          (a.support.selectstart = "onselectstart" in M.createElement("div")),
          a.fn.extend({
            ...
            zIndex: function (e) {
              ...
              if (this.length)
                for (var t, n, i = a(this[0]); i.length && i[0] !== M; ) {
                  if (
      ...
      (function (r, e) {
        ...
        r.extend(r.mobile, {
          ...
          (r.mobile.browser.oldIE = (function () {
            for (
              var e = 3, t = M.createElement("div"), n = t.all || [];
              (t.innerHTML =
          ...
          r.extend(r.support, {
            ...
            cssTransform3d: (function () {
              ...
              if (o) return !!o;
              for (n in ((e = M.createElement("div")),
              (t = {
            ...
            scrollTop:
              ("pageXOffset" in S ||
                "scrollTop" in M.documentElement ||
                "scrollTop" in C[0]) &&
              !$ &&
              !N,
            dynamicBaseTag:
            ...
            cssPointerEvents:
              ...
              "pointerEvents" in s.style &&
                ...
                !!o)),
            boundingRect:
              void 0 !== M.createElement("div").getBoundingClientRect,
            inlineSVG: function () {
              var e = S,
                t = !(
          ...
          (r.mobile.ajaxBlacklist = (S.blackberry && !S.WebKitPoint) || N || n),
          n &&
            r(function () {
            ...
            ((n && n[e]) ||
              ...
              ((i = (function (e, t) {
                ...
                if (
                  ...
                  for (c = 0, u = k.length; c < u; c++) e[(r = k[c])] = a[r];
                return e;
              })(t, e)),
        ...
        function g(e) {
          if (!P) {
            var t = f(e).touches[0],
              ...
              o = r(e.target);
            (I = I || Math.abs(t.pageX - S) > i || Math.abs(t.pageY - M) > i) &&
              !n &&
              c("vmousecancel", e, o),
              c("vmousemove", e, o),
              a();
      ...
      if (o == t)
        for (u = c.r1; u <= c.r2; u++) {
          for (a = 0, r = c.g1; r <= c.g2; r++)
            for (s = c.b1; s <= c.b2; s++) a += e[$(u, r, s)] || 0;
          (d += a), (h[u] = d);
        }
      else if (o == n)
        for (u = c.g1; u <= c.g2; u++) {
          for (a = 0, r = c.r1; r <= c.r2; r++)
            for (s = c.b1; s <= c.b2; s++) a += e[$(r, u, s)] || 0;
          (d += a), (h[u] = d);
        }
      else
        for (u = c.b1; u <= c.b2; u++) {
          for (a = 0, r = c.r1; r <= c.r2; r++)
            for (s = c.g1; s <= c.g2; s++) a += e[$(r, s, u)] || 0;
          (d += a), (h[u] = d);
        }
      return (
...
function pf_login() {
  ...
  function g(e, t, n) {
    ...
    if (
      (i.find("input").change(function (e) {
        $(this).val()
          ? ($(this).addClass("has_value"), i.addClass("has_value"))
          : ($(this).removeClass("has_value"), i.removeClass("has_value"));
      }),
      "password" == t)
    ) {
      var o;
      if ("ontouchstart" in document.documentElement)
        (o = $(
          '<div class="view_password"><div class="pf_tooltip">点击查看密码</div></div>'
        )).click(function () {
          i.find("input").val() && o.find(".pf_tooltip").addClass("disabled"),
            "text" == i.find("input").attr("type")
              ? i.find("input").attr("type", "password")
              : i.find("input").attr("type", "text");
        });
      else
        (o = $(
          '<div class="view_password"><div class="pf_tooltip">按住查看密码</div></div>'
        ))
          .mousedown(function () {
            i.find("input").val() && o.find(".pf_tooltip").addClass("disabled"),
              i.find("input").attr("type", "text");
  ...
  function v(e, t) {
    ...
    $.ajax({
      url:
        ...
        "pandastudio/user-center/register-new-user/",
      type: "post",
  ...
  function b(e) {
    ...
    $.ajax({
      url:
        pandastudio_framework.route +
        "pandastudio/user-center/send-email-nonce/",
      type: "post",
      data: JSON.stringify({
        email: e,
    ...
    if (0 == e.length) {
      ...
      $("body").append(i),
        ...
        i.on("click", function (e) {
          if (
            "pandastudio_framework_login" == e.target.className &&
            1 == is_show
          ) {
            var t = function () {
                s(),
              ...
              n = !1;
            $(".pandastudio_framework_register__form input").each(function (
              e,
              t
            ) {
              "" !== $(t).val().replace(/ /g, "") && (n = !0);
  ...
  function s(e, t) {
    ...
    n
      .find(".pandastudio_framework_login__card___new")
  ...
  function _(e, t) {
    ...
    n
      .find(".pandastudio_framework_register__card___back")
      .addClass("is_disappearing"),
      window.setTimeout(function () {
        y(n, "is_disappearing", 300, function () {
  ...
  (this.showLogin = function (e, t) {
    var n = w(),
      i = e
        ...
        : "";
    if (t)
      var a = g("".concat(d, "QQ/用户名/邮箱"), "text"),
        l = g("".concat(h, "网站密码"), "password");
    else
      (a = g("".concat(d, "用户名/邮箱"), "text")),
        (l = g("".concat(h, "密码"), "password"));
    var c = $(
        '\n\t\t<div class="pandastudio_framework_login__form___remember">\n\t\t\t<input type="checkbox" id="pf_login_remember"><label for="pf_login_remember">记住我</label>\n\t\t\t<a href="'.concat(
          pandastudio_framework.user_center.find_my_password,
          '" class="forget" target="_blank">忘记密码</a>\n\t\t</div>\n\t\t'
        )
      ),
      u = $(
    ...
    u.on("click", function () {
      ...
      (e = {
        ...
        $.ajax({
          url:
            pandastudio_framework.route +
            "pandastudio/user-center/user-signon/",
          type: "post",
          data: JSON.stringify(e),
        })
          .done(function (e) {
    ...
    var r = n ? 16 : 300;
    y(o, "is_showing", r),
      y(a, "is_showing", r + 350),
      y(l, "is_showing", r + 350 + 100),
      y(c, "is_showing", r + 350 + 100 + 100),
      y(u, "is_showing", r + 350 + 100 + 100 + 100),
      y(
        o.find(".pandastudio_framework_login__card___new"),
        "is_showing",
        r + 350 + 100 + 100 + 100 + 100
      ),
      $("body > .pandastudio_framework_login").append(o);
  }),
    (this.showRegister = function (r) {
      ...
      if (
        ...
        var s = g("".concat(m, "QQ号注册"), "text"),
          a = g("".concat(h, "网站密码"), "password", !0);
      else {
        (s = g("".concat(d, "用户名"), "text")),
          (a = g("".concat(h, "密码"), "password", !0));
      ...
      n.on("click", function () {
        if (r) {
          ...
          if (parseInt(e).toString() !== e || e.length < 5)
            return (
              new PdMessage().notify({
                type: "error",
                notify: "请输入正确的QQ号码",
      ...
      i.prepend(t),
        [s, a, l, c, u].map(function (e) {
          i.find(".pandastudio_framework_register__form").append(e);
        });
      var o = e ? 16 : 300;
      y(i, "is_showing", o),
        y(s, "is_showing", o + 350 + 100),
        y(a, "is_showing", o + 350 + 100 + 100),
        y(l, "is_showing", o + 350 + 100 + 100 + 100),
        y(c, "is_showing", o + 350 + 100 + 100 + 100 + 100),
        y(u, "is_showing", o + 350 + 100 + 100 + 100 + 100 + 100),
        y(t, "is_showing", o + 350 + 100 + 100 + 100 + 100 + 100 + 100),
        $("body > .pandastudio_framework_login").append(i);
    });
}
!(function (e) {
          ...
          function c(e, t, n, i, o, r) {
            ...
            for (a = 0; a < o; a++) {
              for (
                ...
                (B.r = T), (B.g = $), (B.b = N), (B.a = E), (B = B.next);
              for (l = 1; l < P; l++)
                (c = d + ((A < l ? A : l) << 2)),
                  (p += (B.r = T = M[c]) * (S = P - l)),
                  (f += (B.g = $ = M[c + 1]) * S),
                ...
                for (var h, p, f, m, g, v, b = new M(e); !b.eos(); ) {
                  if (((h = b.pos), (f = b.scanUntil(n))))
                    for (var y = 0, w = f.length; y < w; ++y)
                      k((m = f.charAt(y))) ? a.push(s.length) : (c = !0),
                        s.push(["text", m, h, h + 1]),
                        (h += 1),
                        "\n" === m && u();
                  if (!b.scan(n)) break;
                  if (
                    ...
                    b.scan(T),
                    "=" === p
                      ? ((f = b.scanUntil(N)), b.scan(N), b.scanUntil(i))
                      : "{" === p
                      ? ((f = b.scanUntil(o)),
                        b.scan(E),
                        b.scanUntil(i),
    ...
    a.fn.pandaTab = function (e, t) {
      var s = {
        init: function (t, n) {
          ...
          "hover" == o
            ? s.addHoverEvent(t)
            : ("click" == o || s.addHoverEvent(t), s.addClickEvent(t)),
            s.autoScrolling(t, n);
          var r = a(t).attr("native-scrolling");
          void 0 !== r && !1 !== r && s.useNativeScrolling(t),
          ...
          function i() {
            ...
            s.parseActivePosition(e),
              0 < e.get(0).scrollWidth - e.get(0).clientWidth &&
                s.makeScrolling(t),
              e.get(0).scrollWidth < a(t).get(0).scrollWidth &&
                s.hideScrolling(t),
              s.disableScrollingButton(t);
          }
          a(window).resize(function (e) {
            window.setTimeout(function () {
  ...
  (window.add_filter = function (e, t, n) {
    ...
    (null != n && "number" == typeof n) || (n = 10),
      window.Panda_Hook || (window.Panda_Hook = {}),
      window.Panda_Hook[e] || (window.Panda_Hook[e] = []);
  ...
  (jQVue.prototype.$isHuman = {
    ...
    check: function () {
      ...
      return jQVue.prototype.$isHuman.is_Mobile()
        ? n < t && 2 <= t + n
        : n < t && 2 <= t + n && 0 < jQVue.prototype.$isHuman.mouseMove;
    },
    is_Mobile: function () {
...
var e = function () {
  ...
  b = c(
    "Y29uc29sZS53YXJuKCdUaGVtZSBuaVJ2YW5hIHwgRGVzaWduZWQgYnkgUEFOREEgU3R1ZGlvXG5odHRwOi8vcGFuZGEucGFuZGEtc3R1ZGlvLmNuJyk"
  ),
  f = function () {
    return a(c(g + "ik="));
  },
  ...
  new jQVue({
    ...
    methods: {
        ...
        this.c() &&
          $("#coverflow[pandaSlider]").pandaSlider("init", "", {
            onChange: function (e, t) {
              if ("image" == $("#coverflow[pandaSlider]").attr("type"))
                return !1;
      ...
      init_sidebar: function () {
        ...
        e = (e = (e = (e = e.replace(/%3e/g, "RIGHT>right>RIGHT")).replace(
          /%/g,
          "BaiFenHao"
        )).replace(/LEFT<left<LEFT/g, "%3c")).replace(
          /RIGHT>right>RIGHT/g,
          "%3e"
        );
        var t = d(e);
        if (
          ((t = t.replace(/BaiFenHao/g, "%")),
          this.c() && $('[manual-template="sidebar"]').html(t),
          0 == $("aside").length)
        )
          return !1;
        if (
      ...
      init_navbar: function () {
        ...
        this.c() && $(".topNav[pandaTab]").pandaTab("init", 250),
          this.is_Mobile() &&
      ...
      init_categoryNavbar: function () {
        this.c() && $(".categoryNav[pandaTab]").pandaTab(),
          this.is_Mobile() &&
      ...
      global_search: function () {
        ...
        var t = function (t) {
          (t = apply_filters("get_query_data", t)),
            window.setTimeout(function () {
              ...
              (e = $(e)),
                ...
                $(".fullscreen_search .postLists img").imgcomplete(function () {
                  n.make_masonry();
                }),
                ...
                $(".fullscreen_search .searchbox input").removeAttr("disabled"),
      ...
      load_blog_options: function () {
        var t = this,
          n = function (e) {
            (e = apply_filters("get_blog_options", e)).error &&
              t.enable_pageLoader(e.msg),
                  ...
                  $('[jqvue-template="sidebarMenu"]').html(e),
                    ...
                    window.setTimeout(function () {
                      o.find(".nav").removeClass("before_view"),
                        ...
                        do_action("ajax_render_complete");
                    }, 16);
                }, 250))
              : location.reload();
          }),
      ...
      submit_comments: function (e) {
        if ("submit" == $(e.target).attr("type"));
          ...
          if (
            (this.is_user_loggedin ||
              (("" == this.comment_author.replace(/ /g, "")) &
                this.comment_require_name_email && t.push("昵称未填写"),
              ("" == this.comment_email.replace(/ /g, "")) &
                this.comment_require_name_email && t.push("邮箱未填写"),
              ("" != this.comment_email.replace(/ /g, "")) &
                !this.is_Email(this.comment_email) && t.push("邮箱格式错误")),
            0 < t.length &&
              this.optionsLoaded &&
              window.setTimeout(function () {
          ...
          if (0 == t.length && i && this.c()) {
            ...
            if (
              (o.val(pandastudio_framework.nonce),
              $("#cmt_form").append(o),
      ...
      init_comments: function () {
        ...
        if (
          ...
          $(".comment-meta.nick-name.guests").click(function (e) {
            if (!t.optionsLoaded)
              return t.$info("请稍后"), void t.$info("网页还未加载完成");
            $(".comment-meta.nick-name.guests").popover("show"),
              "" != t.comment_author
                ? "" != t.comment_email
                  ? "" != t.comment_url ||
      ...
      ding: function (e) {
        var t = this;
        if ("true" == $(".post-like.like.favorite").attr("is_ajaxing"))
          return this.$info("点赞处理中...", 1), !1;
        if ($(".post-like.like.favorite").hasClass("done"))
          this.$alert("您已经点过赞了！");
        else {
          $(".post-like.like.favorite > .count.number").html(
            '<i class="fas fa-circle-notch fa-spin"></i>'
          ),
            $(".post-like.like.favorite").attr("is_ajaxing", "true"),
            this.$info("点赞处理中...", 1);
          var n = function (e) {
            $(".post-like.like.favorite > .count.number").html(e),
              ...
              $(".post-like.like.favorite").removeAttr("is_ajaxing");
          };
      ...
      c: function () {
        return (
          -1 < window.location.href.indexOf(f()) &&
          (function () {
            try {
              for (
                var t = h(k() + f()), n = "", i = JSON.parse(j()), o = 0;
                o < i.length;
                o++
              )
                (n += t[i[o]]),
                  (n += (o + 1) % 4 == 0 && o !== i.length - 1 ? "-" : "");
              return n == e();
            } catch (e) {}
          })()
        );
