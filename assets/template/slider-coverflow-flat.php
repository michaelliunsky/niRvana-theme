...
<div class="container coverflow-wrapper">
	<div pandaSlider id="coverflow" prev-text='<i class="fas fa-arrow-left"></i>' next-text='<i class="fas fa-arrow-right"></i>' view="2" class="unfull" type="flat" allow-anchor-click <?php echo $carousels_attrs; ?>>
		<?php
