...
<div class="container coverflow-wrapper dark-slider gallery">
    <div pandaSlider id="coverflow" prev-text='<i class="fas fa-arrow-left"></i>'
        ...
        <?php echo $carousels_attrs; ?> style="background-color:
        <?php _eopt('gallery_background_color', 'transparent'); ?>"><?php
foreach ($carousels_contents as $item) {?>
        <div class="page"
            post-id="<?php echo $item['id']; ?>">
            <a class="container flex-row-middle flex-center coverflow"
                href="<?php echo $item['full_img']; ?>"
                target="_blank"><img
                    src="<?php echo $item['full_img']; ?>"
