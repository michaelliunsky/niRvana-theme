            ...
            <div class="col-xs-12">
                <div class="row postLists">
                    ...
                    <div class="article_wrapper post clearfix">
                        <div class="meta"><?php do_action('pf-post-meta-start'); ?><span class="inline-block"><i class="fas fa-user"></i><?php echo get_the_author(); ?> · <?php the_time('n月j日 · Y年') ?></span><?php do_action('pf-post-meta-before-tag'); ?><?php if (get_the_tag_list()) { ?><span class="inline-block"><i class="fas fa-tag"></i><?php the_tags('', ' · ', ''); ?></span><?php } ?><span class="inline-block"><i class="fas fa-clock"></i><?php echo count_words_read_time(); ?></span><?php do_action('pf-post-meta-end'); ?></div>
                        <article class="clearfix"><?php
the_content();?></article><?php include('share-modal.php'); ?>
                    </div><?php
