            ...
            <div class="col-xs-12">
                <div class="row postLists">
                    ...
                    <div class="article_wrapper post clearfix">
                        <div class="meta"><?php do_action('pf-post-meta-start'); ?><span class="inline-block"><i class="fas fa-user"></i><?php echo get_the_author(); ?> · <?php the_time('n月j日 · Y年') ?></span><?php do_action('pf-post-meta-before-tag'); ?><?php
...
}?><?php do_action('pf-post-meta-end'); ?></div>
                        <article class="clearfix">
                            <div class="title_style_01 gallery_title">
                                <h1><?php the_title(); ?></h1>
                            </div><?php
the_content();?>
                        </article><?php include('share-modal.php'); ?>
