...
<div class="categoryNav-wrapper">
    <div pandaTab class="categoryNav" active-class=".current-menu-item,.current-menu-ancestor" sub-class=".sub-menu" prev-text='<i class="fa fa-angle-left" aria-hidden="true"></i>' next-text='<i class="fa fa-angle-right" aria-hidden="true"></i>' sub-trigger="" auto-scrolling><?php
if (has_nav_menu('categoryNav')) {
    wp_nav_menu(array( 'theme_location' => 'categoryNav','container' => false ));
} else {
    echo '
