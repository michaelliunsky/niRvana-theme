<div class="container coverflow-wrapper">
    <div pandaSlider id="coverflow" prev-text='<i class="fas fa-arrow-left"></i>' next-text='<i class="fas fa-arrow-right"></i>' view="0" class="unfull"><?php
        ...
        <div class="page" post-id="<?php echo $item['id']; ?>">
            <div class="container flex-row-middle coverflow">
                ...
                <div class="image flex-center">
                    <div class="card" style="background-image: url(<?php echo $item['cover_img']; ?>);"></div>
                </div>
            </div>
        </div><?php
}?>
