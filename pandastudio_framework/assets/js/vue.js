...
!(function (e, t) {
  ...
  function rn(e, t, n) {
    if (la(t))
      ...
      va(n) ? e.removeAttributeNS(fa, pa(t)) : e.setAttributeNS(fa, t, n);
      ...
      br(e, {
        ...
        chars: function (e) {
          if (
            ...
            if (
              (e =
                c || e.trim() ? (Hr(i) ? e : Xs(e)) : a && t.length ? " " : "")
            ) {
              var n;
              !s && " " !== e && (n = gr(e, As))
  ...
  var ks,
    ...
    uc = function (e) {
      (this.options = e),
        ...
        (this.directives = y(y({}, cc), e.directives));
