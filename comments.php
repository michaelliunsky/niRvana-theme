...
<div id="respond" class="comment-respond clearfix">
    ...
    foreach ($cmt_face_arr as $face) {
        switch ($face['type']) {
            case 'p': $cmt_face_fmt = 'png';
                break;
            case 'g': $cmt_face_fmt = 'gif';
                break;
...
do_action('pf_comment_form_before_face');
    ...
    }do_action('pf_comment_form_after_face');?><a class="comment-meta nick-name guests" tabindex="0" v-show="!this.is_user_loggedin" :html="this.comment_author ? this.comment_author.replace(/ /g, '') != '' ? this.comment_author : '昵称' : '昵称'">
